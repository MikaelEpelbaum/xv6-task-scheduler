...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     126:	68 ec 3e 00 00       	push   $0x3eec
     12b:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     131:	e8 ba 38 00 00       	call   39f0 <printf>
  if(mkdir("iputdir") < 0){
     136:	c7 04 24 7f 3e 00 00 	movl   $0x3e7f,(%esp)
  ...
  if(chdir("iputdir") < 0){
     ...
     14c:	68 7f 3e 00 00       	push   $0x3e7f
  ...
  if(unlink("../iputdir") < 0){
     ...
     164:	68 7c 3e 00 00       	push   $0x3e7c
  ...
  if(chdir("/") < 0){
     ...
     178:	68 a1 3e 00 00       	push   $0x3ea1
  ...
  printf(stdout, "iput test ok\n");
     ...
     18c:	68 24 3f 00 00       	push   $0x3f24
     191:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "mkdir failed\n");
     1a1:	50                   	push   %eax
     1a2:	50                   	push   %eax
     1a3:	68 58 3e 00 00       	push   $0x3e58
     1a8:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 a3 3e 00 00       	push   $0x3ea3
     1bf:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 87 3e 00 00       	push   $0x3e87
     1d6:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 66 3e 00 00       	push   $0x3e66
     1ed:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     206:	68 b3 3e 00 00       	push   $0x3eb3
     20b:	ff 35 e0 5f 00 00    	pushl  0x5fe0
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     22b:	68 7f 3e 00 00       	push   $0x3e7f
    ...
    if(chdir("iputdir") < 0){
     ...
     243:	68 7f 3e 00 00       	push   $0x3e7f
    ...
    if(unlink("../iputdir") < 0){
     ...
     257:	68 7c 3e 00 00       	push   $0x3e7c
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     278:	68 d6 3e 00 00       	push   $0x3ed6
     27d:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     293:	68 87 3e 00 00       	push   $0x3e87
     298:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "fork failed\n");
     2a8:	51                   	push   %ecx
     2a9:	51                   	push   %ecx
     2aa:	68 99 4d 00 00       	push   $0x4d99
     2af:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    exit();
     ...
     2bf:	50                   	push   %eax
     2c0:	50                   	push   %eax
     2c1:	68 c2 3e 00 00       	push   $0x3ec2
     2c6:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     2d6:	52                   	push   %edx
     2d7:	52                   	push   %edx
     2d8:	68 58 3e 00 00       	push   $0x3e58
     2dd:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
000002f0 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     2f6:	68 e8 3e 00 00       	push   $0x3ee8
     2fb:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     301:	e8 ea 36 00 00       	call   39f0 <printf>
  if(mkdir("oidir") < 0){
     306:	c7 04 24 f7 3e 00 00 	movl   $0x3ef7,(%esp)
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     345:	68 7c 4e 00 00       	push   $0x4e7c
     34a:	ff 35 e0 5f 00 00    	pushl  0x5fe0
  ...
  printf(stdout, "openiput test ok\n");
     ...
     38a:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "mkdir oidir failed\n");
     3a5:	51                   	push   %ecx
     3a6:	51                   	push   %ecx
     3a7:	68 fd 3e 00 00       	push   $0x3efd
     3ac:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "fork failed\n");
     3bc:	52                   	push   %edx
     3bd:	52                   	push   %edx
     3be:	68 99 4d 00 00       	push   $0x4d99
     3c3:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "unlink failed\n");
     ...
     3da:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
000003f0 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     3f6:	68 32 3f 00 00       	push   $0x3f32
     3fb:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     401:	e8 ea 35 00 00       	call   39f0 <printf>
  fd = open("echo", 0);
     406:	58                   	pop    %eax
     407:	5a                   	pop    %edx
     408:	6a 00                	push   $0x0
     40a:	68 3d 3f 00 00       	push   $0x3f3d
  ...
  fd = open("doesnotexist", 0);
     ...
     425:	59                   	pop    %ecx
     426:	6a 00                	push   $0x0
     428:	68 55 3f 00 00       	push   $0x3f55
  ...
  printf(stdout, "open test ok\n");
     ...
     43c:	68 80 3f 00 00       	push   $0x3f80
     441:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "open echo failed!\n");
     451:	50                   	push   %eax
     452:	50                   	push   %eax
     453:	68 42 3f 00 00       	push   $0x3f42
     458:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     468:	50                   	push   %eax
     469:	50                   	push   %eax
     46a:	68 62 3f 00 00       	push   $0x3f62
     46f:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
00000480 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     488:	68 8e 3f 00 00       	push   $0x3f8e
     48d:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     493:	e8 58 35 00 00       	call   39f0 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     498:	58                   	pop    %eax
     499:	5a                   	pop    %edx
     49a:	68 02 02 00 00       	push   $0x202
     49f:	68 9f 3f 00 00       	push   $0x3f9f
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     4bb:	68 a5 3f 00 00       	push   $0x3fa5
     4c0:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4d3:	6a 0a                	push   $0xa
     4d5:	68 dc 3f 00 00       	push   $0x3fdc
     4da:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     4ef:	6a 0a                	push   $0xa
     4f1:	68 e7 3f 00 00       	push   $0x3fe7
     4f6:	56                   	push   %esi
  ...
  printf(stdout, "writes ok\n");
     ...
     513:	68 f2 3f 00 00       	push   $0x3ff2
     518:	ff 35 e0 5f 00 00    	pushl  0x5fe0
  ...
  fd = open("small", O_RDONLY);
     ...
     52c:	5e                   	pop    %esi
     52d:	6a 00                	push   $0x0
     52f:	68 9f 3f 00 00       	push   $0x3f9f
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     549:	68 fd 3f 00 00       	push   $0x3ffd
     54e:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     554:	e8 97 34 00 00       	call   39f0 <printf>
  i = read(fd, buf, 2000);
     559:	83 c4 0c             	add    $0xc,%esp
     55c:	68 d0 07 00 00       	push   $0x7d0
     561:	68 c0 87 00 00       	push   $0x87c0
     566:	53                   	push   %ebx
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     57d:	68 31 40 00 00       	push   $0x4031
     582:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     588:	e8 63 34 00 00       	call   39f0 <printf>
  close(fd);
     58d:	89 1c 24             	mov    %ebx,(%esp)
     590:	e8 35 33 00 00       	call   38ca <close>
  if(unlink("small") < 0){
     595:	c7 04 24 9f 3f 00 00 	movl   $0x3f9f,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     5ab:	68 59 40 00 00       	push   $0x4059
     5b0:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     5c8:	53                   	push   %ebx
     5c9:	68 a0 4e 00 00       	push   $0x4ea0
     5ce:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     5e1:	53                   	push   %ebx
     5e2:	68 c4 4e 00 00       	push   $0x4ec4
     5e7:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "error: open small failed!\n");
     5f7:	51                   	push   %ecx
     5f8:	51                   	push   %ecx
     5f9:	68 16 40 00 00       	push   $0x4016
     5fe:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "read failed\n");
     60e:	52                   	push   %edx
     60f:	52                   	push   %edx
     610:	68 5d 43 00 00       	push   $0x435d
     615:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "unlink small failed\n");
     625:	50                   	push   %eax
     626:	50                   	push   %eax
     627:	68 44 40 00 00       	push   $0x4044
     62c:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "error: creat small failed!\n");
     63c:	50                   	push   %eax
     63d:	50                   	push   %eax
     63e:	68 c0 3f 00 00       	push   $0x3fc0
     643:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
00000660 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     668:	68 6d 40 00 00       	push   $0x406d
     66d:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     673:	e8 78 33 00 00       	call   39f0 <printf>
  fd = open("big", O_CREATE|O_RDWR);
     678:	58                   	pop    %eax
     679:	5a                   	pop    %edx
     67a:	68 02 02 00 00       	push   $0x202
     67f:	68 e7 40 00 00       	push   $0x40e7
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6a3:	89 1d c0 87 00 00    	mov    %ebx,0x87c0
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 c0 87 00 00       	push   $0x87c0
     6b3:	56                   	push   %esi
  ...
  fd = open("big", O_RDONLY);
     ...
     6dc:	5e                   	pop    %esi
     6dd:	6a 00                	push   $0x0
     6df:	68 e7 40 00 00       	push   $0x40e7
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 c0 87 00 00       	mov    0x87c0,%eax
    ...
    i = read(fd, buf, 512);
     ...
     71f:	68 c0 87 00 00       	push   $0x87c0
     724:	56                   	push   %esi
  ...
  if(unlink("big") < 0){
     746:	c7 04 24 e7 40 00 00 	movl   $0x40e7,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     760:	68 0e 41 00 00       	push   $0x410e
     765:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     77d:	53                   	push   %ebx
     77e:	68 97 40 00 00       	push   $0x4097
     783:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     793:	50                   	push   %eax
     794:	53                   	push   %ebx
     795:	68 e8 4e 00 00       	push   $0x4ee8
     79a:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     7ad:	50                   	push   %eax
     7ae:	68 eb 40 00 00       	push   $0x40eb
     7b3:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     7c9:	68 ce 40 00 00       	push   $0x40ce
     7ce:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "error: open big failed!\n");
     7de:	51                   	push   %ecx
     7df:	51                   	push   %ecx
     7e0:	68 b5 40 00 00       	push   $0x40b5
     7e5:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "error: creat big failed!\n");
     7f5:	50                   	push   %eax
     7f6:	50                   	push   %eax
     7f7:	68 7d 40 00 00       	push   $0x407d
     7fc:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "unlink big failed\n");
     80c:	50                   	push   %eax
     80d:	50                   	push   %eax
     80e:	68 fb 40 00 00       	push   $0x40fb
     813:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     83c:	68 08 4f 00 00       	push   $0x4f08
     841:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     847:	e8 a4 31 00 00       	call   39f0 <printf>
  name[0] = 'a';
     84c:	c6 05 c0 a7 00 00 61 	movb   $0x61,0xa7c0
  name[2] = '\0';
     853:	c6 05 c2 a7 00 00 00 	movb   $0x0,0xa7c2
     85a:	83 c4 10             	add    $0x10,%esp
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d c1 a7 00 00    	mov    %bl,0xa7c1
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 c0 a7 00 00       	push   $0xa7c0
  ...
  name[0] = 'a';
     88b:	c6 05 c0 a7 00 00 61 	movb   $0x61,0xa7c0
  name[2] = '\0';
     892:	c6 05 c2 a7 00 00 00 	movb   $0x0,0xa7c2
     899:	bb 30 00 00 00       	mov    $0x30,%ebx
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d c1 a7 00 00    	mov    %bl,0xa7c1
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 c0 a7 00 00       	push   $0xa7c0
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c1:	68 30 4f 00 00       	push   $0x4f30
     8c6:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
000008e0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     8e6:	68 1c 41 00 00       	push   $0x411c
     8eb:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     8f1:	e8 fa 30 00 00       	call   39f0 <printf>
  if(mkdir("dir0") < 0){
     8f6:	c7 04 24 28 41 00 00 	movl   $0x4128,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     90c:	68 28 41 00 00       	push   $0x4128
  ...
  if(chdir("..") < 0){
     ...
     924:	68 cd 46 00 00       	push   $0x46cd
  ...
  if(unlink("dir0") < 0){
     ...
     938:	68 28 41 00 00       	push   $0x4128
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     94c:	68 65 41 00 00       	push   $0x4165
     951:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "mkdir failed\n");
     961:	50                   	push   %eax
     962:	50                   	push   %eax
     963:	68 58 3e 00 00       	push   $0x3e58
     968:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "unlink dir0 failed\n");
     978:	50                   	push   %eax
     979:	50                   	push   %eax
     97a:	68 51 41 00 00       	push   $0x4151
     97f:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "chdir .. failed\n");
     98f:	52                   	push   %edx
     990:	52                   	push   %edx
     991:	68 40 41 00 00       	push   $0x4140
     996:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    printf(stdout, "chdir dir0 failed\n");
     9a6:	51                   	push   %ecx
     9a7:	51                   	push   %ecx
     9a8:	68 2d 41 00 00       	push   $0x412d
     9ad:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
000009c0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     9c6:	68 74 41 00 00       	push   $0x4174
     9cb:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     9d1:	e8 1a 30 00 00       	call   39f0 <printf>
  if(exec("echo", echoargv) < 0){
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 e4 5f 00 00       	push   $0x5fe4
     9dd:	68 3d 3f 00 00       	push   $0x3f3d
    ...
    printf(stdout, "exec echo failed\n");
     9f0:	50                   	push   %eax
     9f1:	50                   	push   %eax
     9f2:	68 7f 41 00 00       	push   $0x417f
     9f7:	ff 35 e0 5f 00 00    	pushl  0x5fe0
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 c0 87 00 00       	push   $0x87c0
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b c0 87 00 00 	cmp    %bl,0x87c0(%ebx,%ecx,1)
     ...
     aaa:	68 ae 41 00 00       	push   $0x41ae
     aaf:	6a 01                	push   $0x1
    ...
    close(fds[0]);
     ...
     ade:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ae0:	88 84 03 c0 87 00 00 	mov    %al,0x87c0(%ebx,%eax,1)
     ...
     af6:	68 c0 87 00 00       	push   $0x87c0
  ...
  printf(1, "pipe1 ok\n");
     b3d:	5a                   	pop    %edx
     b3e:	59                   	pop    %ecx
     b3f:	68 d3 41 00 00       	push   $0x41d3
     b44:	6a 01                	push   $0x1
     ...
     b5a:	68 bc 41 00 00       	push   $0x41bc
     b5f:	6a 01                	push   $0x1
    ...
    printf(1, "pipe() failed\n");
     b6b:	57                   	push   %edi
     b6c:	57                   	push   %edi
     b6d:	68 91 41 00 00       	push   $0x4191
     b72:	6a 01                	push   $0x1
    ...
    printf(1, "fork() failed\n");
     b7e:	50                   	push   %eax
     b7f:	50                   	push   %eax
     b80:	68 dd 41 00 00       	push   $0x41dd
     b85:	6a 01                	push   $0x1
    ...
    exit();
     ...
     b91:	56                   	push   %esi
     b92:	56                   	push   %esi
     b93:	68 a0 41 00 00       	push   $0x41a0
     b98:	6a 01                	push   $0x1
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     bb9:	68 ec 41 00 00       	push   $0x41ec
     bbe:	6a 01                	push   $0x1
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c0a:	6a 01                	push   $0x1
     c0c:	68 b1 47 00 00       	push   $0x47b1
     ...
     c21:	50                   	push   %eax
     c22:	50                   	push   %eax
     c23:	68 f6 41 00 00       	push   $0x41f6
     c28:	6a 01                	push   $0x1
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c55:	68 c0 87 00 00       	push   $0x87c0
    ...
    printf(1, "preempt read error");
     c6a:	50                   	push   %eax
     c6b:	50                   	push   %eax
     c6c:	68 0a 42 00 00       	push   $0x420a
     c71:	6a 01                	push   $0x1
  ...
  printf(1, "kill... ");
     c8e:	58                   	pop    %eax
     c8f:	5a                   	pop    %edx
     c90:	68 1d 42 00 00       	push   $0x421d
     c95:	6a 01                	push   $0x1
  ...
  printf(1, "wait... ");
     cb4:	59                   	pop    %ecx
     cb5:	5b                   	pop    %ebx
     cb6:	68 26 42 00 00       	push   $0x4226
     cbb:	6a 01                	push   $0x1
  ...
  printf(1, "preempt ok\n");
     cd1:	5e                   	pop    %esi
     cd2:	5f                   	pop    %edi
     cd3:	68 2f 42 00 00       	push   $0x422f
     cd8:	6a 01                	push   $0x1
...
00000cf0 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d1e:	68 99 4d 00 00       	push   $0x4d99
     d23:	6a 01                	push   $0x1
     ...
     d3b:	68 3b 42 00 00       	push   $0x423b
     d40:	6a 01                	push   $0x1
  ...
  printf(1, "exitwait ok\n");
     ...
     d5b:	68 4b 42 00 00       	push   $0x424b
     d60:	6a 01                	push   $0x1
...
00000d80 <mem>:
{
  ...
  printf(1, "mem test\n");
     d8b:	68 58 42 00 00       	push   $0x4258
     d90:	6a 01                	push   $0x1
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     e01:	58                   	pop    %eax
     e02:	5a                   	pop    %edx
     e03:	68 7c 42 00 00       	push   $0x427c
     e08:	6a 01                	push   $0x1
    ...
    exit();
     ...
     e1b:	68 62 42 00 00       	push   $0x4262
     e20:	6a 01                	push   $0x1
...
00000e50 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     edf:	68 84 4f 00 00       	push   $0x4f84
     ee4:	6a 01                	push   $0x1
  ...
  fd = open("sharedfd", 0);
     ...
     f0c:	5a                   	pop    %edx
     f0d:	6a 00                	push   $0x0
     f0f:	68 93 42 00 00       	push   $0x4293
  ...
  unlink("sharedfd");
     f81:	c7 04 24 93 42 00 00 	movl   $0x4293,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fa3:	68 9c 42 00 00       	push   $0x429c
     fa8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fc3:	68 58 4f 00 00       	push   $0x4f58
     fc8:	6a 01                	push   $0x1
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fdd:	68 a4 4f 00 00       	push   $0x4fa4
     fe2:	6a 01                	push   $0x1
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ff9:	53                   	push   %ebx
     ffa:	57                   	push   %edi
     ffb:	68 a9 42 00 00       	push   $0x42a9
    1000:	6a 01                	push   $0x1
...
00001010 <fourfiles>:
{
  ...
  printf(1, "fourfiles test\n");
    1016:	be be 42 00 00       	mov    $0x42be,%esi
  for(pi = 0; pi < 4; pi++){
    101b:	31 db                	xor    %ebx,%ebx
{
    101d:	83 ec 34             	sub    $0x34,%esp
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 d8 be 42 00 00 	movl   $0x42be,-0x28(%ebp)
    1027:	c7 45 dc 07 44 00 00 	movl   $0x4407,-0x24(%ebp)
  printf(1, "fourfiles test\n");
    102e:	68 c4 42 00 00       	push   $0x42c4
    1033:	6a 01                	push   $0x1
  char *names[] = { "f0", "f1", "f2", "f3" };
    1035:	c7 45 e0 0b 44 00 00 	movl   $0x440b,-0x20(%ebp)
    103c:	c7 45 e4 c1 42 00 00 	movl   $0x42c1,-0x1c(%ebp)
  printf(1, "fourfiles test\n");
  ...
  for(i = 0; i < 2; i++){
    ...
    108e:	c7 45 d0 be 42 00 00 	movl   $0x42be,-0x30(%ebp)
    fd = open(fname, 0);
    ...
    10b8:	68 c0 87 00 00       	push   $0x87c0
    ...
    10ce:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10d0:	0f be b2 c0 87 00 00 	movsbl 0x87c0(%edx),%esi
  ...
  printf(1, "fourfiles ok\n");
    ...
    1122:	68 02 43 00 00       	push   $0x4302
    1127:	6a 01                	push   $0x1
    ...
    1171:	68 c0 87 00 00       	push   $0x87c0
    ...
    1186:	68 c0 87 00 00       	push   $0x87c0
    118b:	56                   	push   %esi
    ...
    11a8:	68 e5 42 00 00       	push   $0x42e5
    11ad:	6a 01                	push   $0x1
    ...
    11b9:	51                   	push   %ecx
    11ba:	51                   	push   %ecx
    11bb:	68 5f 45 00 00       	push   $0x455f
    11c0:	6a 01                	push   $0x1
    ...
    11cc:	53                   	push   %ebx
    11cd:	53                   	push   %ebx
    11ce:	68 99 4d 00 00       	push   $0x4d99
    11d3:	6a 01                	push   $0x1
    ...
    11df:	50                   	push   %eax
    11e0:	53                   	push   %ebx
    11e1:	68 f1 42 00 00       	push   $0x42f1
    11e6:	6a 01                	push   $0x1
    ...
    11f2:	52                   	push   %edx
    11f3:	50                   	push   %eax
    11f4:	68 d4 42 00 00       	push   $0x42d4
    11f9:	6a 01                	push   $0x1
    ...
    1216:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    121b:	68 10 43 00 00       	push   $0x4310
    1220:	6a 01                	push   $0x1
  ...
  printf(1, "createdelete ok\n");
    ...
    1314:	68 23 43 00 00       	push   $0x4323
    1319:	6a 01                	push   $0x1
    ...
    13b2:	52                   	push   %edx
    13b3:	52                   	push   %edx
    13b4:	68 11 3f 00 00       	push   $0x3f11
    13b9:	6a 01                	push   $0x1
    ...
    13d0:	57                   	push   %edi
    13d1:	68 d0 4f 00 00       	push   $0x4fd0
    13d6:	6a 01                	push   $0x1
    ...
    13e2:	51                   	push   %ecx
    13e3:	51                   	push   %ecx
    13e4:	68 5f 45 00 00       	push   $0x455f
    13e9:	6a 01                	push   $0x1
    ...
    13f5:	53                   	push   %ebx
    13f6:	53                   	push   %ebx
    13f7:	68 99 4d 00 00       	push   $0x4d99
    13fc:	6a 01                	push   $0x1
    ...
    1410:	50                   	push   %eax
    1411:	57                   	push   %edi
    1412:	68 f4 4f 00 00       	push   $0x4ff4
    1417:	6a 01                	push   $0x1
...
00001430 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1438:	68 34 43 00 00       	push   $0x4334
    143d:	6a 01                	push   $0x1
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    144b:	68 45 43 00 00       	push   $0x4345
  ...
  write(fd, "hello", 5);
    ...
    1465:	6a 05                	push   $0x5
    1467:	68 6a 43 00 00       	push   $0x436a
    146c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    147b:	5a                   	pop    %edx
    147c:	6a 02                	push   $0x2
    147e:	68 45 43 00 00       	push   $0x4345
  ...
  if(unlink("unlinkread") != 0){
    ...
    1498:	68 45 43 00 00       	push   $0x4345
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14b5:	68 45 43 00 00       	push   $0x4345
  ...
  write(fd1, "yyy", 3);
    14c4:	6a 03                	push   $0x3
    14c6:	68 a2 43 00 00       	push   $0x43a2
    14cb:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14e1:	68 c0 87 00 00       	push   $0x87c0
    14e6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14f8:	80 3d c0 87 00 00 68 	cmpb   $0x68,0x87c0
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 c0 87 00 00       	push   $0x87c0
    150b:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1522:	c7 04 24 45 43 00 00 	movl   $0x4345,(%esp)
    1529:	e8 c4 23 00 00       	call   38f2 <unlink>
  printf(1, "unlinkread ok\n");
    152e:	58                   	pop    %eax
    152f:	5a                   	pop    %edx
    1530:	68 ed 43 00 00       	push   $0x43ed
    1535:	6a 01                	push   $0x1
    ...
    1546:	51                   	push   %ecx
    1547:	51                   	push   %ecx
    1548:	68 50 43 00 00       	push   $0x4350
    154d:	6a 01                	push   $0x1
    ...
    1559:	51                   	push   %ecx
    155a:	51                   	push   %ecx
    155b:	68 d4 43 00 00       	push   $0x43d4
    1560:	6a 01                	push   $0x1
    ...
    156c:	53                   	push   %ebx
    156d:	53                   	push   %ebx
    156e:	68 bd 43 00 00       	push   $0x43bd
    1573:	6a 01                	push   $0x1
    ...
    157f:	56                   	push   %esi
    1580:	56                   	push   %esi
    1581:	68 a6 43 00 00       	push   $0x43a6
    1586:	6a 01                	push   $0x1
    ...
    1592:	50                   	push   %eax
    1593:	50                   	push   %eax
    1594:	68 88 43 00 00       	push   $0x4388
    1599:	6a 01                	push   $0x1
    ...
    15a5:	50                   	push   %eax
    15a6:	50                   	push   %eax
    15a7:	68 70 43 00 00       	push   $0x4370
    15ac:	6a 01                	push   $0x1
...
000015c0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    15c7:	68 fc 43 00 00       	push   $0x43fc
    15cc:	6a 01                	push   $0x1
    15ce:	e8 1d 24 00 00       	call   39f0 <printf>
  unlink("lf1");
    15d3:	c7 04 24 06 44 00 00 	movl   $0x4406,(%esp)
    15da:	e8 13 23 00 00       	call   38f2 <unlink>
  unlink("lf2");
    15df:	c7 04 24 0a 44 00 00 	movl   $0x440a,(%esp)
    15e6:	e8 07 23 00 00       	call   38f2 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
    15eb:	58                   	pop    %eax
    15ec:	5a                   	pop    %edx
    15ed:	68 02 02 00 00       	push   $0x202
    15f2:	68 06 44 00 00       	push   $0x4406
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    160c:	6a 05                	push   $0x5
    160e:	68 6a 43 00 00       	push   $0x436a
    1613:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    162e:	5b                   	pop    %ebx
    162f:	58                   	pop    %eax
    1630:	68 0a 44 00 00       	push   $0x440a
    1635:	68 06 44 00 00       	push   $0x4406
  ...
  unlink("lf1");
    ...
    164d:	68 06 44 00 00       	push   $0x4406
    1652:	e8 9b 22 00 00       	call   38f2 <unlink>
  if(open("lf1", 0) >= 0){
    1657:	58                   	pop    %eax
    1658:	5a                   	pop    %edx
    1659:	6a 00                	push   $0x0
    165b:	68 06 44 00 00       	push   $0x4406
  ...
  fd = open("lf2", 0);
    ...
    1673:	6a 00                	push   $0x0
    1675:	68 0a 44 00 00       	push   $0x440a
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 c0 87 00 00       	push   $0x87c0
    1699:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    16b4:	58                   	pop    %eax
    16b5:	5a                   	pop    %edx
    16b6:	68 0a 44 00 00       	push   $0x440a
    16bb:	68 0a 44 00 00       	push   $0x440a
  ...
  unlink("lf2");
    ...
    16d3:	68 0a 44 00 00       	push   $0x440a
    16d8:	e8 15 22 00 00       	call   38f2 <unlink>
  if(link("lf2", "lf1") >= 0){
    16dd:	59                   	pop    %ecx
    16de:	5b                   	pop    %ebx
    16df:	68 06 44 00 00       	push   $0x4406
    16e4:	68 0a 44 00 00       	push   $0x440a
  ...
  if(link(".", "lf1") >= 0){
    ...
    16f8:	68 06 44 00 00       	push   $0x4406
    16fd:	68 ce 46 00 00       	push   $0x46ce
  ...
  printf(1, "linktest ok\n");
    ...
    1711:	68 a4 44 00 00       	push   $0x44a4
    1716:	6a 01                	push   $0x1
    ...
    1725:	50                   	push   %eax
    1726:	50                   	push   %eax
    1727:	68 0e 44 00 00       	push   $0x440e
    172c:	6a 01                	push   $0x1
    ...
    1738:	50                   	push   %eax
    1739:	50                   	push   %eax
    173a:	68 88 44 00 00       	push   $0x4488
    173f:	6a 01                	push   $0x1
    ...
    174b:	52                   	push   %edx
    174c:	52                   	push   %edx
    174d:	68 3c 50 00 00       	push   $0x503c
    1752:	6a 01                	push   $0x1
    ...
    175e:	50                   	push   %eax
    175f:	50                   	push   %eax
    1760:	68 6a 44 00 00       	push   $0x446a
    1765:	6a 01                	push   $0x1
    ...
    1771:	51                   	push   %ecx
    1772:	51                   	push   %ecx
    1773:	68 59 44 00 00       	push   $0x4459
    1778:	6a 01                	push   $0x1
    ...
    1784:	53                   	push   %ebx
    1785:	53                   	push   %ebx
    1786:	68 48 44 00 00       	push   $0x4448
    178b:	6a 01                	push   $0x1
    ...
    1797:	50                   	push   %eax
    1798:	50                   	push   %eax
    1799:	68 14 50 00 00       	push   $0x5014
    179e:	6a 01                	push   $0x1
    ...
    17aa:	51                   	push   %ecx
    17ab:	51                   	push   %ecx
    17ac:	68 33 44 00 00       	push   $0x4433
    17b1:	6a 01                	push   $0x1
    ...
    17bd:	50                   	push   %eax
    17be:	50                   	push   %eax
    17bf:	68 21 44 00 00       	push   $0x4421
    17c4:	6a 01                	push   $0x1
    ...
    17db:	bf ab aa aa aa       	mov    $0xaaaaaaab,%edi
{
  ...
  printf(1, "concreate test\n");
    17e3:	68 b1 44 00 00       	push   $0x44b1
    17e8:	6a 01                	push   $0x1
  ...
  for(i = 0; i < 40; i++){
    ...
    1895:	53                   	push   %ebx
    1896:	68 c4 44 00 00       	push   $0x44c4
    189b:	6a 01                	push   $0x1
    ...
    18b3:	53                   	push   %ebx
    18b4:	68 c1 44 00 00       	push   $0x44c1
  ...
  for(i = 0; i < 40; i++){
    18d3:	83 c6 01             	add    $0x1,%esi
      link("C0", file);
    18d6:	53                   	push   %ebx
    18d7:	68 c1 44 00 00       	push   $0x44c1
  ...
  fd = open(".", 0);
    ...
    1903:	58                   	pop    %eax
    1904:	6a 00                	push   $0x0
    1906:	68 ce 46 00 00       	push   $0x46ce
  ...
  printf(1, "concreate ok\n");
    ...
    1a53:	68 16 45 00 00       	push   $0x4516
    1a58:	6a 01                	push   $0x1
    ...
    1a6a:	68 99 4d 00 00       	push   $0x4d99
    1a6f:	6a 01                	push   $0x1
    ...
    1a7b:	51                   	push   %ecx
    1a7c:	51                   	push   %ecx
    1a7d:	68 60 50 00 00       	push   $0x5060
    1a82:	6a 01                	push   $0x1
    ...
    1a91:	53                   	push   %ebx
    1a92:	50                   	push   %eax
    1a93:	68 f9 44 00 00       	push   $0x44f9
    1a98:	6a 01                	push   $0x1
    ...
    1aa7:	56                   	push   %esi
    1aa8:	50                   	push   %eax
    1aa9:	68 e0 44 00 00       	push   $0x44e0
    1aae:	6a 01                	push   $0x1
...
00001ad0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    1ad9:	68 24 45 00 00       	push   $0x4524
    1ade:	6a 01                	push   $0x1
    1ae0:	e8 0b 1f 00 00       	call   39f0 <printf>
  unlink("x");
    1ae5:	c7 04 24 b1 47 00 00 	movl   $0x47b1,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b28:	68 b1 47 00 00       	push   $0x47b1
  ...
  for(i = 0; i < 100; i++){
    ...
    1b5d:	68 b1 47 00 00       	push   $0x47b1
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b86:	68 39 45 00 00       	push   $0x4539
    1b8b:	6a 01                	push   $0x1
    ...
    1ba3:	68 b1 47 00 00       	push   $0x47b1
    1ba8:	68 35 45 00 00       	push   $0x4535
    ...
    1bba:	52                   	push   %edx
    1bbb:	52                   	push   %edx
    1bbc:	68 99 4d 00 00       	push   $0x4d99
    1bc1:	6a 01                	push   $0x1
...
00001be0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    1be9:	68 48 45 00 00       	push   $0x4548
    1bee:	6a 01                	push   $0x1
    1bf0:	e8 fb 1d 00 00       	call   39f0 <printf>
  unlink("bd");
    1bf5:	c7 04 24 55 45 00 00 	movl   $0x4555,(%esp)
    1bfc:	e8 f1 1c 00 00       	call   38f2 <unlink>
  fd = open("bd", O_CREATE);
    1c01:	5a                   	pop    %edx
    1c02:	59                   	pop    %ecx
    1c03:	68 00 02 00 00       	push   $0x200
    1c08:	68 55 45 00 00       	push   $0x4555
  ...
  close(fd);
    ...
    if(link("bd", name) != 0){
    1c3c:	57                   	push   %edi
    1c3d:	68 55 45 00 00       	push   $0x4555
    name[1] = '0' + (i / 64);
  ...
  unlink("bd");
    ...
    1c73:	68 55 45 00 00       	push   $0x4555
  ...
  printf(1, "bigdir ok\n");
    ...
    1cbc:	68 97 45 00 00       	push   $0x4597
    1cc1:	6a 01                	push   $0x1
    ...
    1cd6:	68 6e 45 00 00       	push   $0x456e
    1cdb:	6a 01                	push   $0x1
    ...
    1cea:	68 82 45 00 00       	push   $0x4582
    1cef:	6a 01                	push   $0x1
    ...
    1cfb:	50                   	push   %eax
    1cfc:	50                   	push   %eax
    1cfd:	68 58 45 00 00       	push   $0x4558
    1d02:	6a 01                	push   $0x1
...
00001d10 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    1d17:	68 a2 45 00 00       	push   $0x45a2
    1d1c:	6a 01                	push   $0x1
    1d1e:	e8 cd 1c 00 00       	call   39f0 <printf>
  unlink("ff");
    1d23:	c7 04 24 2b 46 00 00 	movl   $0x462b,(%esp)
    1d2a:	e8 c3 1b 00 00       	call   38f2 <unlink>
  if(mkdir("dd") != 0){
    1d2f:	c7 04 24 c8 46 00 00 	movl   $0x46c8,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d4e:	68 01 46 00 00       	push   $0x4601
  ...
  write(fd, "ff", 2);
    ...
    1d68:	6a 02                	push   $0x2
    1d6a:	68 2b 46 00 00       	push   $0x462b
    1d6f:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1d7d:	c7 04 24 c8 46 00 00 	movl   $0x46c8,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1d97:	68 dc 45 00 00       	push   $0x45dc
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1db4:	68 fe 45 00 00       	push   $0x45fe
  ...
  write(fd, "FF", 2);
    ...
    1dce:	6a 02                	push   $0x2
    1dd0:	68 1f 46 00 00       	push   $0x461f
    1dd5:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1de4:	5a                   	pop    %edx
    1de5:	6a 00                	push   $0x0
    1de7:	68 22 46 00 00       	push   $0x4622
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 c0 87 00 00       	push   $0x87c0
    1e0b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e1d:	80 3d c0 87 00 00 66 	cmpb   $0x66,0x87c0
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e33:	5b                   	pop    %ebx
    1e34:	58                   	pop    %eax
    1e35:	68 62 46 00 00       	push   $0x4662
    1e3a:	68 fe 45 00 00       	push   $0x45fe
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e52:	68 fe 45 00 00       	push   $0x45fe
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e6a:	6a 00                	push   $0x0
    1e6c:	68 fe 45 00 00       	push   $0x45fe
  ...
  if(chdir("dd") != 0){
    ...
    1e84:	68 c8 46 00 00       	push   $0x46c8
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1e9c:	68 96 46 00 00       	push   $0x4696
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1eb4:	68 bc 46 00 00       	push   $0x46bc
  ...
  if(chdir("./..") != 0){
    ...
    1ecc:	68 cb 46 00 00       	push   $0x46cb
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1ee4:	6a 00                	push   $0x0
    1ee6:	68 62 46 00 00       	push   $0x4662
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 c0 87 00 00       	push   $0x87c0
    1f0a:	50                   	push   %eax
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1f26:	5b                   	pop    %ebx
    1f27:	6a 00                	push   $0x0
    1f29:	68 fe 45 00 00       	push   $0x45fe
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f46:	68 16 47 00 00       	push   $0x4716
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f63:	68 3b 47 00 00       	push   $0x473b
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f80:	68 c8 46 00 00       	push   $0x46c8
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1f98:	6a 02                	push   $0x2
    1f9a:	68 c8 46 00 00       	push   $0x46c8
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fb2:	6a 01                	push   $0x1
    1fb4:	68 c8 46 00 00       	push   $0x46c8
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fcc:	68 aa 47 00 00       	push   $0x47aa
    1fd1:	68 16 47 00 00       	push   $0x4716
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1fe9:	68 aa 47 00 00       	push   $0x47aa
    1fee:	68 3b 47 00 00       	push   $0x473b
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2006:	68 62 46 00 00       	push   $0x4662
    200b:	68 01 46 00 00       	push   $0x4601
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2023:	68 16 47 00 00       	push   $0x4716
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    203b:	68 3b 47 00 00       	push   $0x473b
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2053:	68 62 46 00 00       	push   $0x4662
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    206b:	68 3b 47 00 00       	push   $0x473b
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2083:	68 16 47 00 00       	push   $0x4716
  ...
  if(chdir("dd/ff") == 0){
    ...
    209b:	68 01 46 00 00       	push   $0x4601
  ...
  if(chdir("dd/xx") == 0){
    ...
    20b3:	68 ad 47 00 00       	push   $0x47ad
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20cb:	68 62 46 00 00       	push   $0x4662
  ...
  if(unlink("dd/ff") != 0){
    ...
    20e3:	68 01 46 00 00       	push   $0x4601
  ...
  if(unlink("dd") == 0){
    ...
    20fb:	68 c8 46 00 00       	push   $0x46c8
  ...
  if(unlink("dd/dd") < 0){
    ...
    2113:	68 dd 45 00 00       	push   $0x45dd
  ...
  if(unlink("dd") < 0){
    ...
    212b:	68 c8 46 00 00       	push   $0x46c8
  ...
  printf(1, "subdir ok\n");
    ...
    2143:	68 aa 48 00 00       	push   $0x48aa
    2148:	6a 01                	push   $0x1
    ...
    2157:	50                   	push   %eax
    2158:	50                   	push   %eax
    2159:	68 47 46 00 00       	push   $0x4647
    215e:	6a 01                	push   $0x1
    ...
    216a:	50                   	push   %eax
    216b:	50                   	push   %eax
    216c:	68 a2 46 00 00       	push   $0x46a2
    2171:	6a 01                	push   $0x1
    ...
    217d:	52                   	push   %edx
    217e:	52                   	push   %edx
    217f:	68 6d 46 00 00       	push   $0x466d
    2184:	6a 01                	push   $0x1
    ...
    2190:	50                   	push   %eax
    2191:	50                   	push   %eax
    2192:	68 1f 47 00 00       	push   $0x471f
    2197:	6a 01                	push   $0x1
    ...
    21a3:	52                   	push   %edx
    21a4:	52                   	push   %edx
    21a5:	68 04 51 00 00       	push   $0x5104
    21aa:	6a 01                	push   $0x1
    ...
    21b6:	52                   	push   %edx
    21b7:	52                   	push   %edx
    21b8:	68 b3 47 00 00       	push   $0x47b3
    21bd:	6a 01                	push   $0x1
    ...
    21c9:	51                   	push   %ecx
    21ca:	51                   	push   %ecx
    21cb:	68 74 51 00 00       	push   $0x5174
    21d0:	6a 01                	push   $0x1
    ...
    21dc:	50                   	push   %eax
    21dd:	50                   	push   %eax
    21de:	68 2e 46 00 00       	push   $0x462e
    21e3:	6a 01                	push   $0x1
    ...
    21ef:	51                   	push   %ecx
    21f0:	51                   	push   %ecx
    21f1:	68 07 46 00 00       	push   $0x4607
    21f6:	6a 01                	push   $0x1
    ...
    2202:	50                   	push   %eax
    2203:	50                   	push   %eax
    2204:	68 d0 46 00 00       	push   $0x46d0
    2209:	6a 01                	push   $0x1
    ...
    2215:	51                   	push   %ecx
    2216:	51                   	push   %ecx
    2217:	68 bc 50 00 00       	push   $0x50bc
    221c:	6a 01                	push   $0x1
    ...
    2228:	53                   	push   %ebx
    2229:	53                   	push   %ebx
    222a:	68 50 51 00 00       	push   $0x5150
    222f:	6a 01                	push   $0x1
    ...
    223b:	50                   	push   %eax
    223c:	50                   	push   %eax
    223d:	68 2c 51 00 00       	push   $0x512c
    2242:	6a 01                	push   $0x1
    ...
    224e:	50                   	push   %eax
    224f:	50                   	push   %eax
    2250:	68 8f 47 00 00       	push   $0x478f
    2255:	6a 01                	push   $0x1
    ...
    2261:	50                   	push   %eax
    2262:	50                   	push   %eax
    2263:	68 76 47 00 00       	push   $0x4776
    2268:	6a 01                	push   $0x1
    ...
    2274:	50                   	push   %eax
    2275:	50                   	push   %eax
    2276:	68 60 47 00 00       	push   $0x4760
    227b:	6a 01                	push   $0x1
    ...
    2287:	50                   	push   %eax
    2288:	50                   	push   %eax
    2289:	68 44 47 00 00       	push   $0x4744
    228e:	6a 01                	push   $0x1
    ...
    229a:	50                   	push   %eax
    229b:	50                   	push   %eax
    229c:	68 85 46 00 00       	push   $0x4685
    22a1:	6a 01                	push   $0x1
    ...
    22ad:	50                   	push   %eax
    22ae:	50                   	push   %eax
    22af:	68 e0 50 00 00       	push   $0x50e0
    22b4:	6a 01                	push   $0x1
    ...
    22c0:	53                   	push   %ebx
    22c1:	53                   	push   %ebx
    22c2:	68 e3 45 00 00       	push   $0x45e3
    22c7:	6a 01                	push   $0x1
    ...
    22d3:	50                   	push   %eax
    22d4:	50                   	push   %eax
    22d5:	68 94 50 00 00       	push   $0x5094
    22da:	6a 01                	push   $0x1
    ...
    22e6:	50                   	push   %eax
    22e7:	50                   	push   %eax
    22e8:	68 c7 45 00 00       	push   $0x45c7
    22ed:	6a 01                	push   $0x1
    ...
    22f9:	50                   	push   %eax
    22fa:	50                   	push   %eax
    22fb:	68 af 45 00 00       	push   $0x45af
    2300:	6a 01                	push   $0x1
    ...
    230c:	50                   	push   %eax
    230d:	50                   	push   %eax
    230e:	68 98 48 00 00       	push   $0x4898
    2313:	6a 01                	push   $0x1
    ...
    231f:	52                   	push   %edx
    2320:	52                   	push   %edx
    2321:	68 83 48 00 00       	push   $0x4883
    2326:	6a 01                	push   $0x1
    ...
    2332:	51                   	push   %ecx
    2333:	51                   	push   %ecx
    2334:	68 98 51 00 00       	push   $0x5198
    2339:	6a 01                	push   $0x1
    ...
    2345:	53                   	push   %ebx
    2346:	53                   	push   %ebx
    2347:	68 6e 48 00 00       	push   $0x486e
    234c:	6a 01                	push   $0x1
    ...
    2358:	50                   	push   %eax
    2359:	50                   	push   %eax
    235a:	68 56 48 00 00       	push   $0x4856
    235f:	6a 01                	push   $0x1
    ...
    236b:	50                   	push   %eax
    236c:	50                   	push   %eax
    236d:	68 3e 48 00 00       	push   $0x483e
    2372:	6a 01                	push   $0x1
    ...
    237e:	50                   	push   %eax
    237f:	50                   	push   %eax
    2380:	68 22 48 00 00       	push   $0x4822
    2385:	6a 01                	push   $0x1
    ...
    2391:	50                   	push   %eax
    2392:	50                   	push   %eax
    2393:	68 06 48 00 00       	push   $0x4806
    2398:	6a 01                	push   $0x1
    ...
    23a4:	50                   	push   %eax
    23a5:	50                   	push   %eax
    23a6:	68 e9 47 00 00       	push   $0x47e9
    23ab:	6a 01                	push   $0x1
    ...
    23b7:	50                   	push   %eax
    23b8:	50                   	push   %eax
    23b9:	68 ce 47 00 00       	push   $0x47ce
    23be:	6a 01                	push   $0x1
    ...
    23ca:	50                   	push   %eax
    23cb:	50                   	push   %eax
    23cc:	68 fb 46 00 00       	push   $0x46fb
    23d1:	6a 01                	push   $0x1
    ...
    23dd:	50                   	push   %eax
    23de:	50                   	push   %eax
    23df:	68 e3 46 00 00       	push   $0x46e3
    23e4:	6a 01                	push   $0x1
...
000023f0 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    23fd:	68 b5 48 00 00       	push   $0x48b5
    2402:	6a 01                	push   $0x1
    2404:	e8 e7 15 00 00       	call   39f0 <printf>
  unlink("bigwrite");
    2409:	c7 04 24 c4 48 00 00 	movl   $0x48c4,(%esp)
    ...
    2428:	68 c4 48 00 00       	push   $0x48c4
    ...
    243e:	53                   	push   %ebx
    243f:	68 c0 87 00 00       	push   $0x87c0
    2444:	50                   	push   %eax
    ...
    2454:	53                   	push   %ebx
    2455:	68 c0 87 00 00       	push   $0x87c0
    245a:	56                   	push   %esi
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
    2476:	c7 04 24 c4 48 00 00 	movl   $0x48c4,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    ...
    2490:	68 f7 48 00 00       	push   $0x48f7
    2495:	6a 01                	push   $0x1
    ...
    24a6:	50                   	push   %eax
    24a7:	53                   	push   %ebx
    24a8:	68 e5 48 00 00       	push   $0x48e5
    24ad:	6a 01                	push   $0x1
    ...
    24bc:	68 cd 48 00 00       	push   $0x48cd
    24c1:	6a 01                	push   $0x1
...
000024d0 <bigfile>:
{
  ...
  fd = open("bigfile", 0);
    ...
    255e:	5f                   	pop    %edi
    255f:	6a 00                	push   $0x0
    2561:	68 20 49 00 00       	push   $0x4920
  ...
  for(i = 0; ; i++){
    ...
    258b:	0f be 05 c0 87 00 00 	movsbl 0x87c0,%eax
    2592:	89 fa                	mov    %edi,%edx
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 eb 88 00 00 	movsbl 0x88eb,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 c0 87 00 00       	push   $0x87c0
    25bb:	56                   	push   %esi
  ...
  unlink("bigfile");
    ...
    25e5:	68 20 49 00 00       	push   $0x4920
    25ea:	e8 03 13 00 00       	call   38f2 <unlink>
  printf(1, "bigfile test ok\n");
    25ef:	58                   	pop    %eax
    25f0:	5a                   	pop    %edx
    25f1:	68 af 49 00 00       	push   $0x49af
    25f6:	6a 01                	push   $0x1
    ...
    260b:	68 7c 49 00 00       	push   $0x497c
    2610:	6a 01                	push   $0x1
    ...
    261f:	68 68 49 00 00       	push   $0x4968
    2624:	6a 01                	push   $0x1
    ...
    2633:	68 53 49 00 00       	push   $0x4953
    2638:	6a 01                	push   $0x1
    ...
    2647:	68 28 49 00 00       	push   $0x4928
    264c:	6a 01                	push   $0x1
    ...
    2658:	53                   	push   %ebx
    2659:	53                   	push   %ebx
    265a:	68 3e 49 00 00       	push   $0x493e
    265f:	6a 01                	push   $0x1
    ...
    266b:	50                   	push   %eax
    266c:	50                   	push   %eax
    266d:	68 12 49 00 00       	push   $0x4912
    2672:	6a 01                	push   $0x1
    ...
    267e:	51                   	push   %ecx
    267f:	51                   	push   %ecx
    2680:	68 95 49 00 00       	push   $0x4995
    2685:	6a 01                	push   $0x1
...
000026a0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    26a6:	68 c0 49 00 00       	push   $0x49c0
    26ab:	6a 01                	push   $0x1
    26ad:	e8 3e 13 00 00       	call   39f0 <printf>
  if(mkdir("12345678901234") != 0){
    26b2:	c7 04 24 fb 49 00 00 	movl   $0x49fb,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26cc:	68 b8 51 00 00       	push   $0x51b8
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26e9:	68 08 52 00 00       	push   $0x5208
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2708:	5a                   	pop    %edx
    2709:	6a 00                	push   $0x0
    270b:	68 78 52 00 00       	push   $0x5278
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2725:	c7 04 24 ec 49 00 00 	movl   $0x49ec,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    273b:	68 14 53 00 00       	push   $0x5314
  ...
  printf(1, "fourteen ok\n");
    ...
    274f:	68 0a 4a 00 00       	push   $0x4a0a
    2754:	6a 01                	push   $0x1
    ...
    2760:	50                   	push   %eax
    2761:	50                   	push   %eax
    2762:	68 cf 49 00 00       	push   $0x49cf
    2767:	6a 01                	push   $0x1
    ...
    2773:	50                   	push   %eax
    2774:	50                   	push   %eax
    2775:	68 34 53 00 00       	push   $0x5334
    277a:	6a 01                	push   $0x1
    ...
    2786:	52                   	push   %edx
    2787:	52                   	push   %edx
    2788:	68 e4 52 00 00       	push   $0x52e4
    278d:	6a 01                	push   $0x1
    ...
    2799:	51                   	push   %ecx
    279a:	51                   	push   %ecx
    279b:	68 a8 52 00 00       	push   $0x52a8
    27a0:	6a 01                	push   $0x1
    ...
    27ac:	51                   	push   %ecx
    27ad:	51                   	push   %ecx
    27ae:	68 38 52 00 00       	push   $0x5238
    27b3:	6a 01                	push   $0x1
    ...
    27bf:	50                   	push   %eax
    27c0:	50                   	push   %eax
    27c1:	68 d8 51 00 00       	push   $0x51d8
    27c6:	6a 01                	push   $0x1
...
000027e0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    27e6:	68 17 4a 00 00       	push   $0x4a17
    27eb:	6a 01                	push   $0x1
    27ed:	e8 fe 11 00 00       	call   39f0 <printf>
  if(mkdir("dots") != 0){
    27f2:	c7 04 24 23 4a 00 00 	movl   $0x4a23,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    280c:	68 23 4a 00 00       	push   $0x4a23
  ...
  if(unlink(".") == 0){
    ...
    2824:	68 ce 46 00 00       	push   $0x46ce
  ...
  if(unlink("..") == 0){
    ...
    283c:	68 cd 46 00 00       	push   $0x46cd
  ...
  if(chdir("/") != 0){
    ...
    2854:	68 a1 3e 00 00       	push   $0x3ea1
  ...
  if(unlink("dots/.") == 0){
    ...
    286c:	68 6b 4a 00 00       	push   $0x4a6b
  ...
  if(unlink("dots/..") == 0){
    ...
    2880:	68 89 4a 00 00       	push   $0x4a89
  ...
  if(unlink("dots") != 0){
    ...
    2894:	68 23 4a 00 00       	push   $0x4a23
  ...
  printf(1, "rmdot ok\n");
    ...
    28a8:	68 be 4a 00 00       	push   $0x4abe
    28ad:	6a 01                	push   $0x1
    ...
    28b9:	50                   	push   %eax
    28ba:	50                   	push   %eax
    28bb:	68 28 4a 00 00       	push   $0x4a28
    28c0:	6a 01                	push   $0x1
    ...
    28cc:	50                   	push   %eax
    28cd:	50                   	push   %eax
    28ce:	68 a9 4a 00 00       	push   $0x4aa9
    28d3:	6a 01                	push   $0x1
    ...
    28df:	52                   	push   %edx
    28e0:	52                   	push   %edx
    28e1:	68 91 4a 00 00       	push   $0x4a91
    28e6:	6a 01                	push   $0x1
    ...
    28f2:	51                   	push   %ecx
    28f3:	51                   	push   %ecx
    28f4:	68 72 4a 00 00       	push   $0x4a72
    28f9:	6a 01                	push   $0x1
    ...
    2905:	50                   	push   %eax
    2906:	50                   	push   %eax
    2907:	68 a3 3e 00 00       	push   $0x3ea3
    290c:	6a 01                	push   $0x1
    ...
    2918:	50                   	push   %eax
    2919:	50                   	push   %eax
    291a:	68 5c 4a 00 00       	push   $0x4a5c
    291f:	6a 01                	push   $0x1
    ...
    292b:	50                   	push   %eax
    292c:	50                   	push   %eax
    292d:	68 4e 4a 00 00       	push   $0x4a4e
    2932:	6a 01                	push   $0x1
    ...
    293e:	50                   	push   %eax
    293f:	50                   	push   %eax
    2940:	68 3b 4a 00 00       	push   $0x4a3b
    2945:	6a 01                	push   $0x1
...
00002960 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    2967:	68 c8 4a 00 00       	push   $0x4ac8
    296c:	6a 01                	push   $0x1
  ...
  fd = open("dirfile", O_CREATE);
    ...
    297a:	68 d5 4a 00 00       	push   $0x4ad5
  ...
  if(chdir("dirfile") == 0){
    2998:	c7 04 24 d5 4a 00 00 	movl   $0x4ad5,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    29b2:	6a 00                	push   $0x0
    29b4:	68 0e 4b 00 00       	push   $0x4b0e
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29d1:	68 0e 4b 00 00       	push   $0x4b0e
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29e9:	68 0e 4b 00 00       	push   $0x4b0e
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a01:	68 0e 4b 00 00       	push   $0x4b0e
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a19:	68 0e 4b 00 00       	push   $0x4b0e
    2a1e:	68 72 4b 00 00       	push   $0x4b72
  ...
  if(unlink("dirfile") != 0){
    ...
    2a36:	68 d5 4a 00 00       	push   $0x4ad5
  ...
  fd = open(".", O_RDWR);
    ...
    2a4e:	6a 02                	push   $0x2
    2a50:	68 ce 46 00 00       	push   $0x46ce
  ...
  fd = open(".", 0);
    ...
    2a68:	6a 00                	push   $0x0
    2a6a:	68 ce 46 00 00       	push   $0x46ce
  ...
  if(write(fd, "x", 1) > 0){
    2a79:	6a 01                	push   $0x1
    2a7b:	68 b1 47 00 00       	push   $0x47b1
    2a80:	50                   	push   %eax
  ...
  printf(1, "dir vs file OK\n");
    2a96:	58                   	pop    %eax
    2a97:	5a                   	pop    %edx
    2a98:	68 a5 4b 00 00       	push   $0x4ba5
    2a9d:	6a 01                	push   $0x1
    ...
    2aac:	50                   	push   %eax
    2aad:	50                   	push   %eax
    2aae:	68 19 4b 00 00       	push   $0x4b19
    2ab3:	6a 01                	push   $0x1
    ...
    2abf:	50                   	push   %eax
    2ac0:	50                   	push   %eax
    2ac1:	68 f4 4a 00 00       	push   $0x4af4
    2ac6:	6a 01                	push   $0x1
    ...
    2ad2:	52                   	push   %edx
    2ad3:	52                   	push   %edx
    2ad4:	68 dd 4a 00 00       	push   $0x4add
    2ad9:	6a 01                	push   $0x1
    ...
    2ae5:	51                   	push   %ecx
    2ae6:	51                   	push   %ecx
    2ae7:	68 91 4b 00 00       	push   $0x4b91
    2aec:	6a 01                	push   $0x1
    ...
    2af8:	53                   	push   %ebx
    2af9:	53                   	push   %ebx
    2afa:	68 88 53 00 00       	push   $0x5388
    2aff:	6a 01                	push   $0x1
    ...
    2b0b:	50                   	push   %eax
    2b0c:	50                   	push   %eax
    2b0d:	68 79 4b 00 00       	push   $0x4b79
    2b12:	6a 01                	push   $0x1
    ...
    2b1e:	50                   	push   %eax
    2b1f:	50                   	push   %eax
    2b20:	68 68 53 00 00       	push   $0x5368
    2b25:	6a 01                	push   $0x1
    ...
    2b31:	50                   	push   %eax
    2b32:	50                   	push   %eax
    2b33:	68 54 4b 00 00       	push   $0x4b54
    2b38:	6a 01                	push   $0x1
    ...
    2b44:	50                   	push   %eax
    2b45:	50                   	push   %eax
    2b46:	68 37 4b 00 00       	push   $0x4b37
    2b4b:	6a 01                	push   $0x1
    ...
    2b64:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    2b6c:	68 b5 4b 00 00       	push   $0x4bb5
    2b71:	6a 01                	push   $0x1
    ...
    2b83:	68 c6 4b 00 00       	push   $0x4bc6
    ...
    2b9b:	68 c6 4b 00 00       	push   $0x4bc6
    ...
    2bb3:	68 7b 42 00 00       	push   $0x427b
    2bb8:	e8 4d 0d 00 00       	call   390a <mkdir>
    link("README", "");
    2bbd:	59                   	pop    %ecx
    2bbe:	58                   	pop    %eax
    2bbf:	68 7b 42 00 00       	push   $0x427b
    2bc4:	68 72 4b 00 00       	push   $0x4b72
    2bc9:	e8 34 0d 00 00       	call   3902 <link>
    fd = open("", O_CREATE);
    2bce:	58                   	pop    %eax
    2bcf:	5a                   	pop    %edx
    2bd0:	68 00 02 00 00       	push   $0x200
    2bd5:	68 7b 42 00 00       	push   $0x427b
    ...
    2bfa:	68 b0 47 00 00       	push   $0x47b0
    ...
    2c1a:	68 b0 47 00 00       	push   $0x47b0
  ...
  chdir("/");
    ...
    2c33:	68 a1 3e 00 00       	push   $0x3ea1
    2c38:	e8 d5 0c 00 00       	call   3912 <chdir>
  printf(1, "empty file name OK\n");
    2c3d:	58                   	pop    %eax
    2c3e:	5a                   	pop    %edx
    2c3f:	68 f4 4b 00 00       	push   $0x4bf4
    2c44:	6a 01                	push   $0x1
    ...
    2c56:	68 cc 4b 00 00       	push   $0x4bcc
    2c5b:	6a 01                	push   $0x1
    ...
    2c6a:	68 e0 4b 00 00       	push   $0x4be0
    2c6f:	6a 01                	push   $0x1
    ...
    2c84:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    2c89:	68 08 4c 00 00       	push   $0x4c08
    2c8e:	6a 01                	push   $0x1
  ...
  printf(1, "fork test OK\n");
    ...
    2cdb:	68 3a 4c 00 00       	push   $0x4c3a
    2ce0:	6a 01                	push   $0x1
    ...
    2cf3:	68 a8 53 00 00       	push   $0x53a8
    2cf8:	6a 01                	push   $0x1
    ...
    2d0c:	68 13 4c 00 00       	push   $0x4c13
    2d11:	6a 01                	push   $0x1
    ...
    2d1d:	50                   	push   %eax
    2d1e:	50                   	push   %eax
    2d1f:	68 27 4c 00 00       	push   $0x4c27
    2d24:	6a 01                	push   $0x1
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
  ...
  printf(stdout, "sbrk test\n");
    2d3b:	68 48 4c 00 00       	push   $0x4c48
    2d40:	ff 35 e0 5f 00 00    	pushl  0x5fe0
  ...
  *lastaddr = 99;
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f5a:	6a 01                	push   $0x1
    2f5c:	68 b1 47 00 00       	push   $0x47b1
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fce:	68 f0 4c 00 00       	push   $0x4cf0
    2fd3:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    2fed:	56                   	push   %esi
    2fee:	57                   	push   %edi
    2fef:	68 53 4c 00 00       	push   $0x4c53
    2ff4:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3020:	50                   	push   %eax
    3021:	50                   	push   %eax
    3022:	68 d5 4c 00 00       	push   $0x4cd5
    3027:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3037:	52                   	push   %edx
    3038:	52                   	push   %edx
    3039:	68 91 41 00 00       	push   $0x4191
    303e:	6a 01                	push   $0x1
    ...
    304d:	50                   	push   %eax
    304e:	56                   	push   %esi
    304f:	68 bc 4c 00 00       	push   $0x4cbc
    3054:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    306c:	51                   	push   %ecx
    306d:	51                   	push   %ecx
    306e:	68 99 4d 00 00       	push   $0x4d99
    3073:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3083:	50                   	push   %eax
    3084:	56                   	push   %esi
    3085:	68 9c 54 00 00       	push   $0x549c
    308a:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    309a:	53                   	push   %ebx
    309b:	53                   	push   %ebx
    309c:	68 6c 54 00 00       	push   $0x546c
    30a1:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    30b1:	57                   	push   %edi
    30b2:	56                   	push   %esi
    30b3:	68 44 54 00 00       	push   $0x5444
    30b8:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    30c8:	50                   	push   %eax
    30c9:	56                   	push   %esi
    30ca:	68 0c 54 00 00       	push   $0x540c
    30cf:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    30df:	56                   	push   %esi
    30e0:	56                   	push   %esi
    30e1:	68 a1 4c 00 00       	push   $0x4ca1
    30e6:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    30f6:	57                   	push   %edi
    30f7:	57                   	push   %edi
    30f8:	68 cc 53 00 00       	push   $0x53cc
    30fd:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3112:	50                   	push   %eax
    3113:	50                   	push   %eax
    3114:	68 85 4c 00 00       	push   $0x4c85
    3119:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3129:	50                   	push   %eax
    312a:	50                   	push   %eax
    312b:	68 6e 4c 00 00       	push   $0x4c6e
    3130:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
00003150 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    315a:	68 fe 4c 00 00       	push   $0x4cfe
    315f:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    319f:	5a                   	pop    %edx
    31a0:	53                   	push   %ebx
    31a1:	68 0d 4d 00 00       	push   $0x4d0d
  ...
  printf(stdout, "validate ok\n");
    ...
    31c4:	68 31 4d 00 00       	push   $0x4d31
    31c9:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    31e6:	68 18 4d 00 00       	push   $0x4d18
    31eb:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    3206:	68 3e 4d 00 00       	push   $0x4d3e
    320b:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    3211:	e8 da 07 00 00       	call   39f0 <printf>
    if(uninit[i] != '\0'){
    3216:	83 c4 10             	add    $0x10,%esp
    3219:	80 3d a0 60 00 00 00 	cmpb   $0x0,0x60a0
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3230:	80 b8 a0 60 00 00 00 	cmpb   $0x0,0x60a0(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    3246:	68 59 4d 00 00       	push   $0x4d59
    324b:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    325e:	68 48 4d 00 00       	push   $0x4d48
    3263:	ff 35 e0 5f 00 00    	pushl  0x5fe0
...
00003280 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    3286:	68 66 4d 00 00       	push   $0x4d66
  ...
  fd = open("bigarg-ok", 0);
    ...
    32aa:	6a 00                	push   $0x0
    32ac:	68 66 4d 00 00       	push   $0x4d66
  ...
  unlink("bigarg-ok");
    32ca:	c7 04 24 66 4d 00 00 	movl   $0x4d66,(%esp)
    32d1:	e8 1c 06 00 00       	call   38f2 <unlink>
}
    32d6:	83 c4 10             	add    $0x10,%esp
    32d9:	c9                   	leave  
    32da:	c3                   	ret    
    32db:	b8 00 60 00 00       	mov    $0x6000,%eax
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    32e0:	c7 00 c0 54 00 00    	movl   $0x54c0,(%eax)
    32e6:	83 c0 04             	add    $0x4,%eax
    for(i = 0; i < MAXARG-1; i++)
    32e9:	3d 7c 60 00 00       	cmp    $0x607c,%eax
    32ee:	75 f0                	jne    32e0 <bigargtest+0x60>
    printf(stdout, "bigarg test\n");
    32f0:	51                   	push   %ecx
    32f1:	51                   	push   %ecx
    32f2:	68 70 4d 00 00       	push   $0x4d70
    32f7:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    args[MAXARG-1] = 0;
    32fd:	c7 05 7c 60 00 00 00 	movl   $0x0,0x607c
    3304:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    330c:	58                   	pop    %eax
    330d:	5a                   	pop    %edx
    330e:	68 00 60 00 00       	push   $0x6000
    3313:	68 3d 3f 00 00       	push   $0x3f3d
    3318:	e8 bd 05 00 00       	call   38da <exec>
    printf(stdout, "bigarg test ok\n");
    331d:	59                   	pop    %ecx
    331e:	58                   	pop    %eax
    331f:	68 7d 4d 00 00       	push   $0x4d7d
    3324:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    332a:	e8 c1 06 00 00       	call   39f0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    332f:	58                   	pop    %eax
    3330:	5a                   	pop    %edx
    3331:	68 00 02 00 00       	push   $0x200
    3336:	68 66 4d 00 00       	push   $0x4d66
    ...
    334d:	50                   	push   %eax
    334e:	50                   	push   %eax
    334f:	68 a6 4d 00 00       	push   $0x4da6
    3354:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3364:	52                   	push   %edx
    3365:	52                   	push   %edx
    3366:	68 8d 4d 00 00       	push   $0x4d8d
    336b:	ff 35 e0 5f 00 00    	pushl  0x5fe0
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    338b:	68 bb 4d 00 00       	push   $0x4dbb
    3390:	6a 01                	push   $0x1
    ...
    3413:	50                   	push   %eax
    3414:	68 c8 4d 00 00       	push   $0x4dc8
    3419:	6a 01                	push   $0x1
    ...
    344a:	68 c0 87 00 00       	push   $0x87c0
    344f:	57                   	push   %edi
    ...
    3462:	56                   	push   %esi
    3463:	68 e4 4d 00 00       	push   $0x4de4
    3468:	6a 01                	push   $0x1
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3496:	50                   	push   %eax
    3497:	68 d4 4d 00 00       	push   $0x4dd4
    349c:	6a 01                	push   $0x1
  ...
  printf(1, "fsfull test finished\n");
    ...
    352a:	68 f4 4d 00 00       	push   $0x4df4
    352f:	6a 01                	push   $0x1
...
00003550 <uio>:
{
  ...
  printf(1, "uio test\n");
    3556:	68 0a 4e 00 00       	push   $0x4e0a
    355b:	6a 01                	push   $0x1
  ...
  printf(1, "uio test done\n");
    ...
    3578:	68 14 4e 00 00       	push   $0x4e14
    357d:	6a 01                	push   $0x1
    ...
    359a:	52                   	push   %edx
    359b:	52                   	push   %edx
    359c:	68 a0 55 00 00       	push   $0x55a0
    35a1:	6a 01                	push   $0x1
    ...
    35ad:	50                   	push   %eax
    35ae:	50                   	push   %eax
    35af:	68 99 4d 00 00       	push   $0x4d99
    35b4:	6a 01                	push   $0x1
...
000035c0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    35c7:	6a 00                	push   $0x0
    35c9:	68 23 4e 00 00       	push   $0x4e23
  ...
  printf(1, "arg test passed\n");
    35fd:	58                   	pop    %eax
    35fe:	5a                   	pop    %edx
    35ff:	68 35 4e 00 00       	push   $0x4e35
    3604:	6a 01                	push   $0x1
    ...
    3613:	51                   	push   %ecx
    3614:	51                   	push   %ecx
    3615:	68 28 4e 00 00       	push   $0x4e28
    361a:	6a 02                	push   $0x2
...
00003630 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 dc 5f 00 00 0d 	imul   $0x19660d,0x5fdc,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    3643:	a3 dc 5f 00 00       	mov    %eax,0x5fdc
}
    3648:	c3                   	ret    
...
00003942 <halt>:
SYSCALL(halt)
    3942:	b8 32 00 00 00       	mov    $0x32,%eax
    3947:	cd 40                	int    $0x40
    3949:	c3                   	ret    
    ...
    3959:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    3987:	f7 f1                	div    %ecx
    3989:	0f b6 92 f8 55 00 00 	movzbl 0x55f8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3ba4:	e9 8f fe ff ff       	jmp    3a38 <printf+0x48>
          s = "(null)";
    3ba9:	bb ee 55 00 00       	mov    $0x55ee,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3bc1:	a1 80 60 00 00       	mov    0x6080,%eax
{
  ...
  freep = p;
    3bff:	a3 80 60 00 00       	mov    %eax,0x6080
}
    3c04:	5b                   	pop    %ebx
    3c05:	5e                   	pop    %esi
    3c06:	5f                   	pop    %edi
    ...
    3c16:	72 ce                	jb     3be6 <free+0x26>
{
  ...
  freep = p;
    3c3a:	a3 80 60 00 00       	mov    %eax,0x6080
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c5c:	8b 15 80 60 00 00    	mov    0x6080,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3ca1:	39 05 80 60 00 00    	cmp    %eax,0x6080
  ...
  return freep;
    3ccb:	8b 15 80 60 00 00    	mov    0x6080,%edx
    ...
    3cf4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    3cf7:	89 15 80 60 00 00    	mov    %edx,0x6080
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d10:	c7 05 80 60 00 00 84 	movl   $0x6084,0x6080
    3d17:	60 00 00 
    3d1a:	c7 05 84 60 00 00 84 	movl   $0x6084,0x6084
    3d21:	60 00 00 
    base.s.size = 0;
    3d24:	b8 84 60 00 00       	mov    $0x6084,%eax
    3d29:	c7 05 88 60 00 00 00 	movl   $0x0,0x6088
    3d30:	00 00 00 
...
void check_proc_order(){
    ...
    3d55:	31 db                	xor    %ebx,%ebx
void check_proc_order(){
    3d57:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
    3d5a:	e8 c3 fb ff ff       	call   3922 <getpid>
    3d5f:	83 ec 04             	sub    $0x4,%esp
    3d62:	50                   	push   %eax
    3d63:	68 09 56 00 00       	push   $0x5609
    3d68:	6a 01                	push   $0x1
    3d6a:	e8 81 fc ff ff       	call   39f0 <printf>
    3d6f:	83 c4 10             	add    $0x10,%esp
    3d72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
    3d78:	e8 1d fb ff ff       	call   389a <fork>
        if (pid < 0) {
    3d7d:	85 c0                	test   %eax,%eax
        int pid = fork();
    3d7f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
    3d81:	78 4d                	js     3dd0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
    3d83:	74 64                	je     3de9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
    3d85:	83 c3 01             	add    $0x1,%ebx
    3d88:	83 fb 07             	cmp    $0x7,%ebx
    3d8b:	75 eb                	jne    3d78 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
    3d8d:	e8 18 fb ff ff       	call   38aa <wait>
    3d92:	e8 13 fb ff ff       	call   38aa <wait>
    3d97:	e8 0e fb ff ff       	call   38aa <wait>
    3d9c:	e8 09 fb ff ff       	call   38aa <wait>
    3da1:	e8 04 fb ff ff       	call   38aa <wait>
    3da6:	e8 ff fa ff ff       	call   38aa <wait>
    3dab:	e8 fa fa ff ff       	call   38aa <wait>
    }
    printf(1,"\nPARENT finished\n");
    3db0:	83 ec 08             	sub    $0x8,%esp
    3db3:	68 3c 56 00 00       	push   $0x563c
    3db8:	6a 01                	push   $0x1
    3dba:	e8 31 fc ff ff       	call   39f0 <printf>
    3dbf:	83 c4 10             	add    $0x10,%esp
}
    3dc2:	8d 65 f8             	lea    -0x8(%ebp),%esp
    3dc5:	5b                   	pop    %ebx
    3dc6:	5e                   	pop    %esi
    3dc7:	5d                   	pop    %ebp
    3dc8:	c3                   	ret    
    ...
    3dd3:	68 1f 56 00 00       	push   $0x561f
    3dd8:	6a 01                	push   $0x1
    3dda:	e8 11 fc ff ff       	call   39f0 <printf>
            return;
    3ddf:	83 c4 10             	add    $0x10,%esp
}
    3de2:	8d 65 f8             	lea    -0x8(%ebp),%esp
    3de5:	5b                   	pop    %ebx
    3de6:	5e                   	pop    %esi
    3de7:	5d                   	pop    %ebp
    3de8:	c3                   	ret    
            int prio = prio_keys[k]; // index k inherited from parent
    3de9:	8b 1c 9d 70 56 00 00 	mov    0x5670(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
    3df0:	e8 2d fb ff ff       	call   3922 <getpid>
    3df5:	53                   	push   %ebx
    3df6:	50                   	push   %eax
    3df7:	68 50 56 00 00       	push   $0x5650
    3dfc:	6a 01                	push   $0x1
    3dfe:	e8 ed fb ff ff       	call   39f0 <printf>
            set_priority(prio);
    3e03:	89 1c 24             	mov    %ebx,(%esp)
    3e06:	e8 45 00 00 00       	call   3e50 <set_priority>
    3e0b:	dd 05 90 60 00 00    	fldl   0x6090
    3e11:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
    3e14:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
    3e17:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
    3e1a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
    3e1d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
    3e23:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
    3e25:	75 ed                	jne    3e14 <check_proc_order+0xc4>
    3e27:	dd 1d 90 60 00 00    	fstpl  0x6090
            printf(1,"\nChild(%d) DONE\n", getpid());
    3e2d:	e8 f0 fa ff ff       	call   3922 <getpid>
    3e32:	83 ec 04             	sub    $0x4,%esp
    3e35:	50                   	push   %eax
    3e36:	68 2b 56 00 00       	push   $0x562b
    3e3b:	6a 01                	push   $0x1
    3e3d:	e8 ae fb ff ff       	call   39f0 <printf>
            exit();
    3e42:	e8 5b fa ff ff       	call   38a2 <exit>
    3e47:	66 90                	xchg   %ax,%ax
    3e49:	66 90                	xchg   %ax,%ax
    3e4b:	66 90                	xchg   %ax,%ax
    3e4d:	66 90                	xchg   %ax,%ax
    3e4f:	90                   	nop

00003e50 <set_priority>:
