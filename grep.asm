 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 20 10 00 00    	lea    0x1020(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb 20 10 00 00       	mov    $0x1020,%ebx
    buf[m] = '\0';
 26c:	c6 86 20 10 00 00 00 	movb   $0x0,0x1020(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb 20 10 00 00    	cmp    $0x1020,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d 20 10 00 00       	sub    $0x1020,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 20 10 00 00       	push   $0x1020
...
00000622 <halt>:
SYSCALL(halt)
 622:	b8 32 00 00 00       	mov    $0x32,%eax
 627:	cd 40                	int    $0x40
 629:	c3                   	ret    
 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 78 0b 00 00 	movzbl 0xb78(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb 6e 0b 00 00       	mov    $0xb6e,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 00 10 00 00       	mov    0x1000,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 00 10 00 00       	mov    %eax,0x1000
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 00 10 00 00       	mov    %eax,0x1000
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 939:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 93c:	8b 15 00 10 00 00    	mov    0x1000,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	73 47                	jae    9c8 <malloc+0x98>
    ...
    if(p == freep)
 981:	39 05 00 10 00 00    	cmp    %eax,0x1000
 ...
 9a6:	e8 f5 fe ff ff       	call   8a0 <free>
  return freep;
 9ab:	8b 15 00 10 00 00    	mov    0x1000,%edx
 ...
 9d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9d7:	89 15 00 10 00 00    	mov    %edx,0x1000
}
 ...
 9e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 00 10 00 00 04 	movl   $0x1004,0x1000
 9f7:	10 00 00 
 9fa:	c7 05 04 10 00 00 04 	movl   $0x1004,0x1004
 a01:	10 00 00 
    base.s.size = 0;
 a04:	b8 04 10 00 00       	mov    $0x1004,%eax
 a09:	c7 05 08 10 00 00 00 	movl   $0x0,0x1008
 a10:	00 00 00 
...
void check_proc_order(){
 a37:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 a3a:	e8 c3 fb ff ff       	call   602 <getpid>
 a3f:	83 ec 04             	sub    $0x4,%esp
 a42:	50                   	push   %eax
 a43:	68 89 0b 00 00       	push   $0xb89
 a48:	6a 01                	push   $0x1
 a4a:	e8 81 fc ff ff       	call   6d0 <printf>
 a4f:	83 c4 10             	add    $0x10,%esp
 a52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 a58:	e8 1d fb ff ff       	call   57a <fork>
        if (pid < 0) {
 a5d:	85 c0                	test   %eax,%eax
        int pid = fork();
 a5f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 a61:	78 4d                	js     ab0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 a63:	74 64                	je     ac9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 a65:	83 c3 01             	add    $0x1,%ebx
 a68:	83 fb 07             	cmp    $0x7,%ebx
 a6b:	75 eb                	jne    a58 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 a6d:	e8 18 fb ff ff       	call   58a <wait>
 a72:	e8 13 fb ff ff       	call   58a <wait>
 a77:	e8 0e fb ff ff       	call   58a <wait>
 a7c:	e8 09 fb ff ff       	call   58a <wait>
 a81:	e8 04 fb ff ff       	call   58a <wait>
 a86:	e8 ff fa ff ff       	call   58a <wait>
 a8b:	e8 fa fa ff ff       	call   58a <wait>
    }
    printf(1,"\nPARENT finished\n");
 a90:	83 ec 08             	sub    $0x8,%esp
 a93:	68 bc 0b 00 00       	push   $0xbbc
 a98:	6a 01                	push   $0x1
 a9a:	e8 31 fc ff ff       	call   6d0 <printf>
 a9f:	83 c4 10             	add    $0x10,%esp
}
 aa2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 aa5:	5b                   	pop    %ebx
 aa6:	5e                   	pop    %esi
 aa7:	5d                   	pop    %ebp
 aa8:	c3                   	ret    
 ...
 ab3:	68 9f 0b 00 00       	push   $0xb9f
 ab8:	6a 01                	push   $0x1
 aba:	e8 11 fc ff ff       	call   6d0 <printf>
            return;
 ...
 ac9:	8b 1c 9d f0 0b 00 00 	mov    0xbf0(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 ad0:	e8 2d fb ff ff       	call   602 <getpid>
 ad5:	53                   	push   %ebx
 ad6:	50                   	push   %eax
 ad7:	68 d0 0b 00 00       	push   $0xbd0
 adc:	6a 01                	push   $0x1
 ade:	e8 ed fb ff ff       	call   6d0 <printf>
            set_priority(prio);
 ae3:	89 1c 24             	mov    %ebx,(%esp)
 ae6:	e8 45 00 00 00       	call   b30 <set_priority>
 aeb:	dd 05 10 10 00 00    	fldl   0x1010
 af1:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 af4:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 af7:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 afa:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 afd:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 b03:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 b05:	75 ed                	jne    af4 <check_proc_order+0xc4>
 b07:	dd 1d 10 10 00 00    	fstpl  0x1010
            printf(1,"\nChild(%d) DONE\n", getpid());
 b0d:	e8 f0 fa ff ff       	call   602 <getpid>
 b12:	83 ec 04             	sub    $0x4,%esp
 b15:	50                   	push   %eax
 b16:	68 ab 0b 00 00       	push   $0xbab
 b1b:	6a 01                	push   $0x1
 b1d:	e8 ae fb ff ff       	call   6d0 <printf>
            exit();
 b22:	e8 5b fa ff ff       	call   582 <exit>
