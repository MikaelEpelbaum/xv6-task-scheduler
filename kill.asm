 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 84 08 00 00 	movzbl 0x884(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 7c 08 00 00       	mov    $0x87c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 08 0c 00 00       	mov    0xc08,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 08 0c 00 00       	mov    %eax,0xc08
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 08 0c 00 00       	mov    %eax,0xc08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 08 0c 00 00    	mov    0xc08,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 08 0c 00 00    	cmp    %eax,0xc08
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 08 0c 00 00    	mov    0xc08,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 08 0c 00 00    	mov    %edx,0xc08
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 08 0c 00 00 0c 	movl   $0xc0c,0xc08
 727:	0c 00 00 
 72a:	c7 05 0c 0c 00 00 0c 	movl   $0xc0c,0xc0c
 731:	0c 00 00 
    base.s.size = 0;
 734:	b8 0c 0c 00 00       	mov    $0xc0c,%eax
 739:	c7 05 10 0c 00 00 00 	movl   $0x0,0xc10
 740:	00 00 00 
...
void check_proc_order(){
 ...
 837:	dd 1d 18 0c 00 00    	fstpl  0xc18
            printf(1,"\nChild(%d) DONE\n", getpid());
 83d:	e8 f0 fa ff ff       	call   332 <getpid>
 842:	83 ec 04             	sub    $0x4,%esp
 845:	50                   	push   %eax
 846:	68 b7 08 00 00       	push   $0x8b7
 84b:	6a 01                	push   $0x1
