...
00000352 <halt>:
SYSCALL(halt)
 352:	b8 32 00 00 00       	mov    $0x32,%eax
 357:	cd 40                	int    $0x40
 359:	c3                   	ret    
 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 397:	f7 f1                	div    %ecx
 399:	0f b6 92 98 08 00 00 	movzbl 0x898(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 8f 08 00 00       	mov    $0x88f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d1:	a1 18 0c 00 00       	mov    0xc18,%eax
{
 ...
 60d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 60f:	a3 18 0c 00 00       	mov    %eax,0xc18
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 18 0c 00 00       	mov    %eax,0xc18
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 18 0c 00 00    	mov    0xc18,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
    ...
    if(p == freep)
 6b1:	39 05 18 0c 00 00    	cmp    %eax,0xc18
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
  return freep;
 6db:	8b 15 18 0c 00 00    	mov    0xc18,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 707:	89 15 18 0c 00 00    	mov    %edx,0xc18
}
 ...
 719:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 18 0c 00 00 1c 	movl   $0xc1c,0xc18
 727:	0c 00 00 
 72a:	c7 05 1c 0c 00 00 1c 	movl   $0xc1c,0xc1c
 731:	0c 00 00 
    base.s.size = 0;
 734:	b8 1c 0c 00 00       	mov    $0xc1c,%eax
 739:	c7 05 20 0c 00 00 00 	movl   $0x0,0xc20
 740:	00 00 00 
...
void check_proc_order(){
 767:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 76a:	e8 c3 fb ff ff       	call   332 <getpid>
 76f:	83 ec 04             	sub    $0x4,%esp
 772:	50                   	push   %eax
 773:	68 a9 08 00 00       	push   $0x8a9
 778:	6a 01                	push   $0x1
 77a:	e8 81 fc ff ff       	call   400 <printf>
 77f:	83 c4 10             	add    $0x10,%esp
 782:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 788:	e8 1d fb ff ff       	call   2aa <fork>
        if (pid < 0) {
 78d:	85 c0                	test   %eax,%eax
        int pid = fork();
 78f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 791:	78 4d                	js     7e0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 793:	74 64                	je     7f9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 795:	83 c3 01             	add    $0x1,%ebx
 798:	83 fb 07             	cmp    $0x7,%ebx
 79b:	75 eb                	jne    788 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 79d:	e8 18 fb ff ff       	call   2ba <wait>
 7a2:	e8 13 fb ff ff       	call   2ba <wait>
 7a7:	e8 0e fb ff ff       	call   2ba <wait>
 7ac:	e8 09 fb ff ff       	call   2ba <wait>
 7b1:	e8 04 fb ff ff       	call   2ba <wait>
 7b6:	e8 ff fa ff ff       	call   2ba <wait>
 7bb:	e8 fa fa ff ff       	call   2ba <wait>
    }
    printf(1,"\nPARENT finished\n");
 7c0:	83 ec 08             	sub    $0x8,%esp
 7c3:	68 dc 08 00 00       	push   $0x8dc
 7c8:	6a 01                	push   $0x1
 7ca:	e8 31 fc ff ff       	call   400 <printf>
 7cf:	83 c4 10             	add    $0x10,%esp
}
 7d2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 7d5:	5b                   	pop    %ebx
 7d6:	5e                   	pop    %esi
 7d7:	5d                   	pop    %ebp
 7d8:	c3                   	ret    
 ...
 7e3:	68 bf 08 00 00       	push   $0x8bf
 7e8:	6a 01                	push   $0x1
 7ea:	e8 11 fc ff ff       	call   400 <printf>
            return;
 ...
 7f9:	8b 1c 9d 10 09 00 00 	mov    0x910(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 800:	e8 2d fb ff ff       	call   332 <getpid>
 805:	53                   	push   %ebx
 806:	50                   	push   %eax
 807:	68 f0 08 00 00       	push   $0x8f0
 80c:	6a 01                	push   $0x1
 80e:	e8 ed fb ff ff       	call   400 <printf>
            set_priority(prio);
 813:	89 1c 24             	mov    %ebx,(%esp)
 816:	e8 45 00 00 00       	call   860 <set_priority>
 81b:	dd 05 28 0c 00 00    	fldl   0xc28
 821:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 824:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 827:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 82a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 82d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 833:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 835:	75 ed                	jne    824 <check_proc_order+0xc4>
 837:	dd 1d 28 0c 00 00    	fstpl  0xc28
            printf(1,"\nChild(%d) DONE\n", getpid());
 83d:	e8 f0 fa ff ff       	call   332 <getpid>
 842:	83 ec 04             	sub    $0x4,%esp
 845:	50                   	push   %eax
 846:	68 cb 08 00 00       	push   $0x8cb
 84b:	6a 01                	push   $0x1
 84d:	e8 ae fb ff ff       	call   400 <printf>
            exit();
 852:	e8 5b fa ff ff       	call   2b2 <exit>
