...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 cb 78 10 80 	movl   $0x801078cb,(%esp)
...
80102e62:	e8 89 28 00 00       	call   801056f0 <idtinit>
...
80102e86:	e8 55 39 00 00       	call   801067e0 <switchkvm>
  seginit();
80102e8b:	e8 c0 38 00 00       	call   80106750 <seginit>
  lapicinit();
...
80102ed0:	e8 7b 38 00 00       	call   80106750 <seginit>
  picinit();       // disable pic
...
80102ee9:	e8 32 08 00 00       	call   80103720 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 7d 27 00 00       	call   80105670 <tvinit>
  binit();         // buffer cache
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 5b 56 10 80 	movl   $0x8010565b,0x14(%eax)
  p->context = (struct context*)sp;
...
80103823:	e8 08 34 00 00       	call   80106c30 <setupkvm>
...
8010396a:	e8 11 32 00 00       	call   80106b80 <deallocuvm>
...
801039b8:	e8 43 33 00 00       	call   80106d00 <copyuvm>
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 d2 2c 00 00       	call   80106bb0 <freevm>
        release(&ptable.lock);
...
8010402b:	68 cb 78 10 80       	push   $0x801078cb
...
80104857:	83 fa 31             	cmp    $0x31,%edx
...
801049d4:	68 a8 76 10 80       	push   $0x801076a8
...
801049ec:	68 a7 76 10 80       	push   $0x801076a7
...
80104a05:	68 9b 76 10 80       	push   $0x8010769b
...
80104a1a:	68 aa 76 10 80       	push   $0x801076aa
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 8c 76 10 80       	push   $0x8010768c
...
80104e19:	58                   	pop    %eax
80104e1a:	5a                   	pop    %edx
80104e1b:	68 a8 76 10 80       	push   $0x801076a8
...
80104e34:	68 a7 76 10 80       	push   $0x801076a7
...
80105630:	55                   	push   %ebp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105631:	b8 00 20 00 00       	mov    $0x2000,%eax
80105636:	ba 04 06 00 00       	mov    $0x604,%edx
8010563b:	89 e5                	mov    %esp,%ebp
8010563d:	66 ef                	out    %ax,(%dx)
  outw(0x604, 0x2000);
  return 0;
}
...
80105644:	06                   	push   %es
  pushl %fs
80105645:	0f a0                	push   %fs
  pushl %gs
80105647:	0f a8                	push   %gs
  pushal
80105649:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010564a:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010564e:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105650:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105652:	54                   	push   %esp
  call trap
80105653:	e8 c8 00 00 00       	call   80105720 <trap>
  addl $4, %esp
80105658:	83 c4 04             	add    $0x4,%esp
...
8010565b:	61                   	popa   
  popl %gs
8010565c:	0f a9                	pop    %gs
  popl %fs
8010565e:	0f a1                	pop    %fs
  popl %es
80105660:	07                   	pop    %es
  popl %ds
80105661:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105662:	83 c4 08             	add    $0x8,%esp
  iret
80105665:	cf                   	iret   
...
801056be:	00 00 ef 
  initlock(&tickslock, "time");
801056c1:	68 ed 76 10 80       	push   $0x801076ed
...
801056d4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801056da:	e8 21 eb ff ff       	call   80104200 <initlock>
}
...
80105740:	ff 24 85 94 77 10 80 	jmp    *-0x7fef886c(,%eax,4)
...
80105750:	e8 8b e0 ff ff       	call   801037e0 <myproc>
...
80105770:	e8 4b e0 ff ff       	call   801037c0 <cpuid>
...
80105781:	e8 5a e0 ff ff       	call   801037e0 <myproc>
80105786:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105789:	e8 52 e0 ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801057a5:	68 50 77 10 80       	push   $0x80107750
801057aa:	e8 b1 ae ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057af:	83 c4 20             	add    $0x20,%esp
801057b2:	e8 29 e0 ff ff       	call   801037e0 <myproc>
...
801057be:	e8 1d e0 ff ff       	call   801037e0 <myproc>
801057c3:	85 c0                	test   %eax,%eax
801057c5:	74 1d                	je     801057e4 <trap+0xc4>
801057c7:	e8 14 e0 ff ff       	call   801037e0 <myproc>
...
801057e4:	e8 f7 df ff ff       	call   801037e0 <myproc>
801057e9:	85 c0                	test   %eax,%eax
801057eb:	74 0b                	je     801057f8 <trap+0xd8>
801057ed:	e8 ee df ff ff       	call   801037e0 <myproc>
...
80105801:	e8 da df ff ff       	call   801037e0 <myproc>
...
8010583d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105840:	e8 fb ef ff ff       	call   80104840 <syscall>
    if(myproc()->killed)
80105845:	e8 96 df ff ff       	call   801037e0 <myproc>
...
80105894:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105898:	e8 73 cd ff ff       	call   80102610 <kbdintr>
    lapiceoi();
...
801058df:	e8 dc de ff ff       	call   801037c0 <cpuid>
801058e4:	56                   	push   %esi
801058e5:	53                   	push   %ebx
801058e6:	50                   	push   %eax
801058e7:	68 f8 76 10 80       	push   $0x801076f8
801058ec:	e8 6f ad ff ff       	call   80100660 <cprintf>
    lapiceoi();
801058f1:	e8 5a ce ff ff       	call   80102750 <lapiceoi>
    break;
801058f6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058f9:	e8 e2 de ff ff       	call   801037e0 <myproc>
...
80105985:	68 1c 77 10 80       	push   $0x8010771c
8010598a:	e8 d1 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
8010598f:	83 c4 14             	add    $0x14,%esp
80105992:	68 f2 76 10 80       	push   $0x801076f2
...
80105a8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105a8f:	bb 14 78 10 80       	mov    $0x80107814,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b27:	6a 00                	push   $0x0
  jmp alltraps
80105b29:	e9 15 fb ff ff       	jmp    80105643 <alltraps>
...
80105b30:	6a 01                	push   $0x1
  jmp alltraps
80105b32:	e9 0c fb ff ff       	jmp    80105643 <alltraps>
...
80105b39:	6a 02                	push   $0x2
  jmp alltraps
80105b3b:	e9 03 fb ff ff       	jmp    80105643 <alltraps>
...
80105b42:	6a 03                	push   $0x3
  jmp alltraps
80105b44:	e9 fa fa ff ff       	jmp    80105643 <alltraps>
...
80105b4b:	6a 04                	push   $0x4
  jmp alltraps
80105b4d:	e9 f1 fa ff ff       	jmp    80105643 <alltraps>
...
80105b54:	6a 05                	push   $0x5
  jmp alltraps
80105b56:	e9 e8 fa ff ff       	jmp    80105643 <alltraps>
...
80105b5d:	6a 06                	push   $0x6
  jmp alltraps
80105b5f:	e9 df fa ff ff       	jmp    80105643 <alltraps>
...
80105b66:	6a 07                	push   $0x7
  jmp alltraps
80105b68:	e9 d6 fa ff ff       	jmp    80105643 <alltraps>
...
80105b6d:	6a 08                	push   $0x8
  jmp alltraps
80105b6f:	e9 cf fa ff ff       	jmp    80105643 <alltraps>
...
80105b76:	6a 09                	push   $0x9
  jmp alltraps
80105b78:	e9 c6 fa ff ff       	jmp    80105643 <alltraps>
...
80105b7d:	6a 0a                	push   $0xa
  jmp alltraps
80105b7f:	e9 bf fa ff ff       	jmp    80105643 <alltraps>
...
80105b84:	6a 0b                	push   $0xb
  jmp alltraps
80105b86:	e9 b8 fa ff ff       	jmp    80105643 <alltraps>
...
80105b8b:	6a 0c                	push   $0xc
  jmp alltraps
80105b8d:	e9 b1 fa ff ff       	jmp    80105643 <alltraps>
...
80105b92:	6a 0d                	push   $0xd
  jmp alltraps
80105b94:	e9 aa fa ff ff       	jmp    80105643 <alltraps>
...
80105b99:	6a 0e                	push   $0xe
  jmp alltraps
80105b9b:	e9 a3 fa ff ff       	jmp    80105643 <alltraps>
...
80105ba2:	6a 0f                	push   $0xf
  jmp alltraps
80105ba4:	e9 9a fa ff ff       	jmp    80105643 <alltraps>
...
80105bab:	6a 10                	push   $0x10
  jmp alltraps
80105bad:	e9 91 fa ff ff       	jmp    80105643 <alltraps>
...
80105bb2:	6a 11                	push   $0x11
  jmp alltraps
80105bb4:	e9 8a fa ff ff       	jmp    80105643 <alltraps>
...
80105bbb:	6a 12                	push   $0x12
  jmp alltraps
80105bbd:	e9 81 fa ff ff       	jmp    80105643 <alltraps>
...
80105bc4:	6a 13                	push   $0x13
  jmp alltraps
80105bc6:	e9 78 fa ff ff       	jmp    80105643 <alltraps>
...
80105bcd:	6a 14                	push   $0x14
  jmp alltraps
80105bcf:	e9 6f fa ff ff       	jmp    80105643 <alltraps>
...
80105bd6:	6a 15                	push   $0x15
  jmp alltraps
80105bd8:	e9 66 fa ff ff       	jmp    80105643 <alltraps>
...
80105bdf:	6a 16                	push   $0x16
  jmp alltraps
80105be1:	e9 5d fa ff ff       	jmp    80105643 <alltraps>
...
80105be8:	6a 17                	push   $0x17
  jmp alltraps
80105bea:	e9 54 fa ff ff       	jmp    80105643 <alltraps>
...
80105bf1:	6a 18                	push   $0x18
  jmp alltraps
80105bf3:	e9 4b fa ff ff       	jmp    80105643 <alltraps>
...
80105bfa:	6a 19                	push   $0x19
  jmp alltraps
80105bfc:	e9 42 fa ff ff       	jmp    80105643 <alltraps>
...
80105c03:	6a 1a                	push   $0x1a
  jmp alltraps
80105c05:	e9 39 fa ff ff       	jmp    80105643 <alltraps>
...
80105c0c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c0e:	e9 30 fa ff ff       	jmp    80105643 <alltraps>
...
80105c15:	6a 1c                	push   $0x1c
  jmp alltraps
80105c17:	e9 27 fa ff ff       	jmp    80105643 <alltraps>
...
80105c1e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c20:	e9 1e fa ff ff       	jmp    80105643 <alltraps>
...
80105c27:	6a 1e                	push   $0x1e
  jmp alltraps
80105c29:	e9 15 fa ff ff       	jmp    80105643 <alltraps>
...
80105c30:	6a 1f                	push   $0x1f
  jmp alltraps
80105c32:	e9 0c fa ff ff       	jmp    80105643 <alltraps>
...
80105c39:	6a 20                	push   $0x20
  jmp alltraps
80105c3b:	e9 03 fa ff ff       	jmp    80105643 <alltraps>
...
80105c42:	6a 21                	push   $0x21
  jmp alltraps
80105c44:	e9 fa f9 ff ff       	jmp    80105643 <alltraps>
...
80105c4b:	6a 22                	push   $0x22
  jmp alltraps
80105c4d:	e9 f1 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c54:	6a 23                	push   $0x23
  jmp alltraps
80105c56:	e9 e8 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c5d:	6a 24                	push   $0x24
  jmp alltraps
80105c5f:	e9 df f9 ff ff       	jmp    80105643 <alltraps>
...
80105c66:	6a 25                	push   $0x25
  jmp alltraps
80105c68:	e9 d6 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c6f:	6a 26                	push   $0x26
  jmp alltraps
80105c71:	e9 cd f9 ff ff       	jmp    80105643 <alltraps>
...
80105c78:	6a 27                	push   $0x27
  jmp alltraps
80105c7a:	e9 c4 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c81:	6a 28                	push   $0x28
  jmp alltraps
80105c83:	e9 bb f9 ff ff       	jmp    80105643 <alltraps>
...
80105c8a:	6a 29                	push   $0x29
  jmp alltraps
80105c8c:	e9 b2 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c93:	6a 2a                	push   $0x2a
  jmp alltraps
80105c95:	e9 a9 f9 ff ff       	jmp    80105643 <alltraps>
...
80105c9c:	6a 2b                	push   $0x2b
  jmp alltraps
80105c9e:	e9 a0 f9 ff ff       	jmp    80105643 <alltraps>
...
80105ca5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ca7:	e9 97 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cae:	6a 2d                	push   $0x2d
  jmp alltraps
80105cb0:	e9 8e f9 ff ff       	jmp    80105643 <alltraps>
...
80105cb7:	6a 2e                	push   $0x2e
  jmp alltraps
80105cb9:	e9 85 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cc0:	6a 2f                	push   $0x2f
  jmp alltraps
80105cc2:	e9 7c f9 ff ff       	jmp    80105643 <alltraps>
...
80105cc9:	6a 30                	push   $0x30
  jmp alltraps
80105ccb:	e9 73 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cd2:	6a 31                	push   $0x31
  jmp alltraps
80105cd4:	e9 6a f9 ff ff       	jmp    80105643 <alltraps>
...
80105cdb:	6a 32                	push   $0x32
  jmp alltraps
80105cdd:	e9 61 f9 ff ff       	jmp    80105643 <alltraps>
...
80105ce4:	6a 33                	push   $0x33
  jmp alltraps
80105ce6:	e9 58 f9 ff ff       	jmp    80105643 <alltraps>
...
80105ced:	6a 34                	push   $0x34
  jmp alltraps
80105cef:	e9 4f f9 ff ff       	jmp    80105643 <alltraps>
...
80105cf6:	6a 35                	push   $0x35
  jmp alltraps
80105cf8:	e9 46 f9 ff ff       	jmp    80105643 <alltraps>
...
80105cff:	6a 36                	push   $0x36
  jmp alltraps
80105d01:	e9 3d f9 ff ff       	jmp    80105643 <alltraps>
...
80105d08:	6a 37                	push   $0x37
  jmp alltraps
80105d0a:	e9 34 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d11:	6a 38                	push   $0x38
  jmp alltraps
80105d13:	e9 2b f9 ff ff       	jmp    80105643 <alltraps>
...
80105d1a:	6a 39                	push   $0x39
  jmp alltraps
80105d1c:	e9 22 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d23:	6a 3a                	push   $0x3a
  jmp alltraps
80105d25:	e9 19 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d2c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d2e:	e9 10 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d35:	6a 3c                	push   $0x3c
  jmp alltraps
80105d37:	e9 07 f9 ff ff       	jmp    80105643 <alltraps>
...
80105d3e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d40:	e9 fe f8 ff ff       	jmp    80105643 <alltraps>
...
80105d47:	6a 3e                	push   $0x3e
  jmp alltraps
80105d49:	e9 f5 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d50:	6a 3f                	push   $0x3f
  jmp alltraps
80105d52:	e9 ec f8 ff ff       	jmp    80105643 <alltraps>
...
80105d59:	6a 40                	push   $0x40
  jmp alltraps
80105d5b:	e9 e3 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d62:	6a 41                	push   $0x41
  jmp alltraps
80105d64:	e9 da f8 ff ff       	jmp    80105643 <alltraps>
...
80105d6b:	6a 42                	push   $0x42
  jmp alltraps
80105d6d:	e9 d1 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d74:	6a 43                	push   $0x43
  jmp alltraps
80105d76:	e9 c8 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d7d:	6a 44                	push   $0x44
  jmp alltraps
80105d7f:	e9 bf f8 ff ff       	jmp    80105643 <alltraps>
...
80105d86:	6a 45                	push   $0x45
  jmp alltraps
80105d88:	e9 b6 f8 ff ff       	jmp    80105643 <alltraps>
...
80105d8f:	6a 46                	push   $0x46
  jmp alltraps
80105d91:	e9 ad f8 ff ff       	jmp    80105643 <alltraps>
...
80105d98:	6a 47                	push   $0x47
  jmp alltraps
80105d9a:	e9 a4 f8 ff ff       	jmp    80105643 <alltraps>
...
80105da1:	6a 48                	push   $0x48
  jmp alltraps
80105da3:	e9 9b f8 ff ff       	jmp    80105643 <alltraps>
...
80105daa:	6a 49                	push   $0x49
  jmp alltraps
80105dac:	e9 92 f8 ff ff       	jmp    80105643 <alltraps>
...
80105db3:	6a 4a                	push   $0x4a
  jmp alltraps
80105db5:	e9 89 f8 ff ff       	jmp    80105643 <alltraps>
...
80105dbc:	6a 4b                	push   $0x4b
  jmp alltraps
80105dbe:	e9 80 f8 ff ff       	jmp    80105643 <alltraps>
...
80105dc5:	6a 4c                	push   $0x4c
  jmp alltraps
80105dc7:	e9 77 f8 ff ff       	jmp    80105643 <alltraps>
...
80105dce:	6a 4d                	push   $0x4d
  jmp alltraps
80105dd0:	e9 6e f8 ff ff       	jmp    80105643 <alltraps>
...
80105dd7:	6a 4e                	push   $0x4e
  jmp alltraps
80105dd9:	e9 65 f8 ff ff       	jmp    80105643 <alltraps>
...
80105de0:	6a 4f                	push   $0x4f
  jmp alltraps
80105de2:	e9 5c f8 ff ff       	jmp    80105643 <alltraps>
...
80105de9:	6a 50                	push   $0x50
  jmp alltraps
80105deb:	e9 53 f8 ff ff       	jmp    80105643 <alltraps>
...
80105df2:	6a 51                	push   $0x51
  jmp alltraps
80105df4:	e9 4a f8 ff ff       	jmp    80105643 <alltraps>
...
80105dfb:	6a 52                	push   $0x52
  jmp alltraps
80105dfd:	e9 41 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e04:	6a 53                	push   $0x53
  jmp alltraps
80105e06:	e9 38 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e0d:	6a 54                	push   $0x54
  jmp alltraps
80105e0f:	e9 2f f8 ff ff       	jmp    80105643 <alltraps>
...
80105e16:	6a 55                	push   $0x55
  jmp alltraps
80105e18:	e9 26 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e1f:	6a 56                	push   $0x56
  jmp alltraps
80105e21:	e9 1d f8 ff ff       	jmp    80105643 <alltraps>
...
80105e28:	6a 57                	push   $0x57
  jmp alltraps
80105e2a:	e9 14 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e31:	6a 58                	push   $0x58
  jmp alltraps
80105e33:	e9 0b f8 ff ff       	jmp    80105643 <alltraps>
...
80105e3a:	6a 59                	push   $0x59
  jmp alltraps
80105e3c:	e9 02 f8 ff ff       	jmp    80105643 <alltraps>
...
80105e43:	6a 5a                	push   $0x5a
  jmp alltraps
80105e45:	e9 f9 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e4c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e4e:	e9 f0 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e55:	6a 5c                	push   $0x5c
  jmp alltraps
80105e57:	e9 e7 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e5e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e60:	e9 de f7 ff ff       	jmp    80105643 <alltraps>
...
80105e67:	6a 5e                	push   $0x5e
  jmp alltraps
80105e69:	e9 d5 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e70:	6a 5f                	push   $0x5f
  jmp alltraps
80105e72:	e9 cc f7 ff ff       	jmp    80105643 <alltraps>
...
80105e79:	6a 60                	push   $0x60
  jmp alltraps
80105e7b:	e9 c3 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e82:	6a 61                	push   $0x61
  jmp alltraps
80105e84:	e9 ba f7 ff ff       	jmp    80105643 <alltraps>
...
80105e8b:	6a 62                	push   $0x62
  jmp alltraps
80105e8d:	e9 b1 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e94:	6a 63                	push   $0x63
  jmp alltraps
80105e96:	e9 a8 f7 ff ff       	jmp    80105643 <alltraps>
...
80105e9d:	6a 64                	push   $0x64
  jmp alltraps
80105e9f:	e9 9f f7 ff ff       	jmp    80105643 <alltraps>
...
80105ea6:	6a 65                	push   $0x65
  jmp alltraps
80105ea8:	e9 96 f7 ff ff       	jmp    80105643 <alltraps>
...
80105eaf:	6a 66                	push   $0x66
  jmp alltraps
80105eb1:	e9 8d f7 ff ff       	jmp    80105643 <alltraps>
...
80105eb8:	6a 67                	push   $0x67
  jmp alltraps
80105eba:	e9 84 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ec1:	6a 68                	push   $0x68
  jmp alltraps
80105ec3:	e9 7b f7 ff ff       	jmp    80105643 <alltraps>
...
80105eca:	6a 69                	push   $0x69
  jmp alltraps
80105ecc:	e9 72 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ed3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ed5:	e9 69 f7 ff ff       	jmp    80105643 <alltraps>
...
80105edc:	6a 6b                	push   $0x6b
  jmp alltraps
80105ede:	e9 60 f7 ff ff       	jmp    80105643 <alltraps>
...
80105ee5:	6a 6c                	push   $0x6c
  jmp alltraps
80105ee7:	e9 57 f7 ff ff       	jmp    80105643 <alltraps>
...
80105eee:	6a 6d                	push   $0x6d
  jmp alltraps
80105ef0:	e9 4e f7 ff ff       	jmp    80105643 <alltraps>
...
80105ef7:	6a 6e                	push   $0x6e
  jmp alltraps
80105ef9:	e9 45 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f00:	6a 6f                	push   $0x6f
  jmp alltraps
80105f02:	e9 3c f7 ff ff       	jmp    80105643 <alltraps>
...
80105f09:	6a 70                	push   $0x70
  jmp alltraps
80105f0b:	e9 33 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f12:	6a 71                	push   $0x71
  jmp alltraps
80105f14:	e9 2a f7 ff ff       	jmp    80105643 <alltraps>
...
80105f1b:	6a 72                	push   $0x72
  jmp alltraps
80105f1d:	e9 21 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f24:	6a 73                	push   $0x73
  jmp alltraps
80105f26:	e9 18 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f2d:	6a 74                	push   $0x74
  jmp alltraps
80105f2f:	e9 0f f7 ff ff       	jmp    80105643 <alltraps>
...
80105f36:	6a 75                	push   $0x75
  jmp alltraps
80105f38:	e9 06 f7 ff ff       	jmp    80105643 <alltraps>
...
80105f3f:	6a 76                	push   $0x76
  jmp alltraps
80105f41:	e9 fd f6 ff ff       	jmp    80105643 <alltraps>
...
80105f48:	6a 77                	push   $0x77
  jmp alltraps
80105f4a:	e9 f4 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f51:	6a 78                	push   $0x78
  jmp alltraps
80105f53:	e9 eb f6 ff ff       	jmp    80105643 <alltraps>
...
80105f5a:	6a 79                	push   $0x79
  jmp alltraps
80105f5c:	e9 e2 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f63:	6a 7a                	push   $0x7a
  jmp alltraps
80105f65:	e9 d9 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f6c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f6e:	e9 d0 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f75:	6a 7c                	push   $0x7c
  jmp alltraps
80105f77:	e9 c7 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f7e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f80:	e9 be f6 ff ff       	jmp    80105643 <alltraps>
...
80105f87:	6a 7e                	push   $0x7e
  jmp alltraps
80105f89:	e9 b5 f6 ff ff       	jmp    80105643 <alltraps>
...
80105f90:	6a 7f                	push   $0x7f
  jmp alltraps
80105f92:	e9 ac f6 ff ff       	jmp    80105643 <alltraps>
...
80105f99:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f9e:	e9 a0 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fa5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105faa:	e9 94 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fb1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fb6:	e9 88 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fbd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fc2:	e9 7c f6 ff ff       	jmp    80105643 <alltraps>
...
80105fc9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fce:	e9 70 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fd5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105fda:	e9 64 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fe1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fe6:	e9 58 f6 ff ff       	jmp    80105643 <alltraps>
...
80105fed:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105ff2:	e9 4c f6 ff ff       	jmp    80105643 <alltraps>
...
80105ff9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105ffe:	e9 40 f6 ff ff       	jmp    80105643 <alltraps>
...
80106005:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010600a:	e9 34 f6 ff ff       	jmp    80105643 <alltraps>
...
80106011:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106016:	e9 28 f6 ff ff       	jmp    80105643 <alltraps>
...
8010601d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106022:	e9 1c f6 ff ff       	jmp    80105643 <alltraps>
...
80106029:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010602e:	e9 10 f6 ff ff       	jmp    80105643 <alltraps>
...
80106035:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010603a:	e9 04 f6 ff ff       	jmp    80105643 <alltraps>
...
80106041:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106046:	e9 f8 f5 ff ff       	jmp    80105643 <alltraps>
...
8010604d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106052:	e9 ec f5 ff ff       	jmp    80105643 <alltraps>
...
80106059:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010605e:	e9 e0 f5 ff ff       	jmp    80105643 <alltraps>
...
80106065:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010606a:	e9 d4 f5 ff ff       	jmp    80105643 <alltraps>
...
80106071:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106076:	e9 c8 f5 ff ff       	jmp    80105643 <alltraps>
...
8010607d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106082:	e9 bc f5 ff ff       	jmp    80105643 <alltraps>
...
80106089:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010608e:	e9 b0 f5 ff ff       	jmp    80105643 <alltraps>
...
80106095:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010609a:	e9 a4 f5 ff ff       	jmp    80105643 <alltraps>
...
801060a1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060a6:	e9 98 f5 ff ff       	jmp    80105643 <alltraps>
...
801060ad:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060b2:	e9 8c f5 ff ff       	jmp    80105643 <alltraps>
...
801060b9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060be:	e9 80 f5 ff ff       	jmp    80105643 <alltraps>
...
801060c5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060ca:	e9 74 f5 ff ff       	jmp    80105643 <alltraps>
...
801060d1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060d6:	e9 68 f5 ff ff       	jmp    80105643 <alltraps>
...
801060dd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060e2:	e9 5c f5 ff ff       	jmp    80105643 <alltraps>
...
801060e9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060ee:	e9 50 f5 ff ff       	jmp    80105643 <alltraps>
...
801060f5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060fa:	e9 44 f5 ff ff       	jmp    80105643 <alltraps>
...
80106101:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106106:	e9 38 f5 ff ff       	jmp    80105643 <alltraps>
...
8010610d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106112:	e9 2c f5 ff ff       	jmp    80105643 <alltraps>
...
80106119:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010611e:	e9 20 f5 ff ff       	jmp    80105643 <alltraps>
...
80106125:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010612a:	e9 14 f5 ff ff       	jmp    80105643 <alltraps>
...
80106131:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106136:	e9 08 f5 ff ff       	jmp    80105643 <alltraps>
...
8010613d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106142:	e9 fc f4 ff ff       	jmp    80105643 <alltraps>
...
80106149:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010614e:	e9 f0 f4 ff ff       	jmp    80105643 <alltraps>
...
80106155:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010615a:	e9 e4 f4 ff ff       	jmp    80105643 <alltraps>
...
80106161:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106166:	e9 d8 f4 ff ff       	jmp    80105643 <alltraps>
...
8010616d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106172:	e9 cc f4 ff ff       	jmp    80105643 <alltraps>
...
80106179:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010617e:	e9 c0 f4 ff ff       	jmp    80105643 <alltraps>
...
80106185:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010618a:	e9 b4 f4 ff ff       	jmp    80105643 <alltraps>
...
80106191:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106196:	e9 a8 f4 ff ff       	jmp    80105643 <alltraps>
...
8010619d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061a2:	e9 9c f4 ff ff       	jmp    80105643 <alltraps>
...
801061a9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061ae:	e9 90 f4 ff ff       	jmp    80105643 <alltraps>
...
801061b5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061ba:	e9 84 f4 ff ff       	jmp    80105643 <alltraps>
...
801061c1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061c6:	e9 78 f4 ff ff       	jmp    80105643 <alltraps>
...
801061cd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061d2:	e9 6c f4 ff ff       	jmp    80105643 <alltraps>
...
801061d9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061de:	e9 60 f4 ff ff       	jmp    80105643 <alltraps>
...
801061e5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061ea:	e9 54 f4 ff ff       	jmp    80105643 <alltraps>
...
801061f1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061f6:	e9 48 f4 ff ff       	jmp    80105643 <alltraps>
...
801061fd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106202:	e9 3c f4 ff ff       	jmp    80105643 <alltraps>
...
80106209:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010620e:	e9 30 f4 ff ff       	jmp    80105643 <alltraps>
...
80106215:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010621a:	e9 24 f4 ff ff       	jmp    80105643 <alltraps>
...
80106221:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106226:	e9 18 f4 ff ff       	jmp    80105643 <alltraps>
...
8010622d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106232:	e9 0c f4 ff ff       	jmp    80105643 <alltraps>
...
80106239:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010623e:	e9 00 f4 ff ff       	jmp    80105643 <alltraps>
...
80106245:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010624a:	e9 f4 f3 ff ff       	jmp    80105643 <alltraps>
...
80106251:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106256:	e9 e8 f3 ff ff       	jmp    80105643 <alltraps>
...
8010625d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106262:	e9 dc f3 ff ff       	jmp    80105643 <alltraps>
...
80106269:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010626e:	e9 d0 f3 ff ff       	jmp    80105643 <alltraps>
...
80106275:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010627a:	e9 c4 f3 ff ff       	jmp    80105643 <alltraps>
...
80106281:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106286:	e9 b8 f3 ff ff       	jmp    80105643 <alltraps>
...
8010628d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106292:	e9 ac f3 ff ff       	jmp    80105643 <alltraps>
...
80106299:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010629e:	e9 a0 f3 ff ff       	jmp    80105643 <alltraps>
...
801062a5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062aa:	e9 94 f3 ff ff       	jmp    80105643 <alltraps>
...
801062b1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062b6:	e9 88 f3 ff ff       	jmp    80105643 <alltraps>
...
801062bd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062c2:	e9 7c f3 ff ff       	jmp    80105643 <alltraps>
...
801062c9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062ce:	e9 70 f3 ff ff       	jmp    80105643 <alltraps>
...
801062d5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062da:	e9 64 f3 ff ff       	jmp    80105643 <alltraps>
...
801062e1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062e6:	e9 58 f3 ff ff       	jmp    80105643 <alltraps>
...
801062ed:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062f2:	e9 4c f3 ff ff       	jmp    80105643 <alltraps>
...
801062f9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062fe:	e9 40 f3 ff ff       	jmp    80105643 <alltraps>
...
80106305:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010630a:	e9 34 f3 ff ff       	jmp    80105643 <alltraps>
...
80106311:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106316:	e9 28 f3 ff ff       	jmp    80105643 <alltraps>
...
8010631d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106322:	e9 1c f3 ff ff       	jmp    80105643 <alltraps>
...
80106329:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010632e:	e9 10 f3 ff ff       	jmp    80105643 <alltraps>
...
80106335:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010633a:	e9 04 f3 ff ff       	jmp    80105643 <alltraps>
...
80106341:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106346:	e9 f8 f2 ff ff       	jmp    80105643 <alltraps>
...
8010634d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106352:	e9 ec f2 ff ff       	jmp    80105643 <alltraps>
...
80106359:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010635e:	e9 e0 f2 ff ff       	jmp    80105643 <alltraps>
...
80106365:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010636a:	e9 d4 f2 ff ff       	jmp    80105643 <alltraps>
...
80106371:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106376:	e9 c8 f2 ff ff       	jmp    80105643 <alltraps>
...
8010637d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106382:	e9 bc f2 ff ff       	jmp    80105643 <alltraps>
...
80106389:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010638e:	e9 b0 f2 ff ff       	jmp    80105643 <alltraps>
...
80106395:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010639a:	e9 a4 f2 ff ff       	jmp    80105643 <alltraps>
...
801063a1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063a6:	e9 98 f2 ff ff       	jmp    80105643 <alltraps>
...
801063ad:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063b2:	e9 8c f2 ff ff       	jmp    80105643 <alltraps>
...
801063b9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063be:	e9 80 f2 ff ff       	jmp    80105643 <alltraps>
...
801063c5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063ca:	e9 74 f2 ff ff       	jmp    80105643 <alltraps>
...
801063d1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063d6:	e9 68 f2 ff ff       	jmp    80105643 <alltraps>
...
801063dd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063e2:	e9 5c f2 ff ff       	jmp    80105643 <alltraps>
...
801063e9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063ee:	e9 50 f2 ff ff       	jmp    80105643 <alltraps>
...
801063f5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063fa:	e9 44 f2 ff ff       	jmp    80105643 <alltraps>
...
80106401:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106406:	e9 38 f2 ff ff       	jmp    80105643 <alltraps>
...
8010640d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106412:	e9 2c f2 ff ff       	jmp    80105643 <alltraps>
...
80106419:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010641e:	e9 20 f2 ff ff       	jmp    80105643 <alltraps>
...
80106425:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010642a:	e9 14 f2 ff ff       	jmp    80105643 <alltraps>
...
80106431:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106436:	e9 08 f2 ff ff       	jmp    80105643 <alltraps>
...
8010643d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106442:	e9 fc f1 ff ff       	jmp    80105643 <alltraps>
...
80106449:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010644e:	e9 f0 f1 ff ff       	jmp    80105643 <alltraps>
...
80106455:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010645a:	e9 e4 f1 ff ff       	jmp    80105643 <alltraps>
...
80106461:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106466:	e9 d8 f1 ff ff       	jmp    80105643 <alltraps>
...
8010646d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106472:	e9 cc f1 ff ff       	jmp    80105643 <alltraps>
...
80106479:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010647e:	e9 c0 f1 ff ff       	jmp    80105643 <alltraps>
...
80106485:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010648a:	e9 b4 f1 ff ff       	jmp    80105643 <alltraps>
...
80106491:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106496:	e9 a8 f1 ff ff       	jmp    80105643 <alltraps>
...
8010649d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064a2:	e9 9c f1 ff ff       	jmp    80105643 <alltraps>
...
801064a9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064ae:	e9 90 f1 ff ff       	jmp    80105643 <alltraps>
...
801064b5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064ba:	e9 84 f1 ff ff       	jmp    80105643 <alltraps>
...
801064c1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064c6:	e9 78 f1 ff ff       	jmp    80105643 <alltraps>
...
801064cd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064d2:	e9 6c f1 ff ff       	jmp    80105643 <alltraps>
...
801064d9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064de:	e9 60 f1 ff ff       	jmp    80105643 <alltraps>
...
801064e5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064ea:	e9 54 f1 ff ff       	jmp    80105643 <alltraps>
...
801064f1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064f6:	e9 48 f1 ff ff       	jmp    80105643 <alltraps>
...
801064fd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106502:	e9 3c f1 ff ff       	jmp    80105643 <alltraps>
...
80106509:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010650e:	e9 30 f1 ff ff       	jmp    80105643 <alltraps>
...
80106515:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010651a:	e9 24 f1 ff ff       	jmp    80105643 <alltraps>
...
80106521:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106526:	e9 18 f1 ff ff       	jmp    80105643 <alltraps>
...
8010652d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106532:	e9 0c f1 ff ff       	jmp    80105643 <alltraps>
...
80106539:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010653e:	e9 00 f1 ff ff       	jmp    80105643 <alltraps>
...
80106545:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010654a:	e9 f4 f0 ff ff       	jmp    80105643 <alltraps>
...
80106551:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106556:	e9 e8 f0 ff ff       	jmp    80105643 <alltraps>
...
8010655d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106562:	e9 dc f0 ff ff       	jmp    80105643 <alltraps>
...
80106569:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010656e:	e9 d0 f0 ff ff       	jmp    80105643 <alltraps>
...
80106575:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010657a:	e9 c4 f0 ff ff       	jmp    80105643 <alltraps>
...
80106581:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106586:	e9 b8 f0 ff ff       	jmp    80105643 <alltraps>
...
8010658d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106592:	e9 ac f0 ff ff       	jmp    80105643 <alltraps>
...
8010669d:	68 1c 78 10 80       	push   $0x8010781c
...
801066f4:	e8 17 bc ff ff       	call   80102310 <kfree>
      *pte = 0;
...
80106753:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106756:	e8 65 d0 ff ff       	call   801037c0 <cpuid>
...
80106970:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106971:	e9 8a db ff ff       	jmp    80104500 <memmove>
    panic("inituvm: more than a page");
80106976:	83 ec 0c             	sub    $0xc,%esp
80106979:	68 61 78 10 80       	push   $0x80107861
...
80106ac9:	0f 86 81 00 00 00    	jbe    80106b50 <allocuvm+0x100>
    mem = kalloc();
80106acf:	e8 ec b9 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106add:	68 99 78 10 80       	push   $0x80107899
...
80106b13:	68 b1 78 10 80       	push   $0x801078b1
...
80106b3b:	e8 d0 b7 ff ff       	call   80102310 <kfree>
      return 0;
...
80106bfe:	e8 0d b7 ff ff       	call   80102310 <kfree>
...
80106c13:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106c14:	e9 f7 b6 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106c19:	83 ec 0c             	sub    $0xc,%esp
80106c1c:	68 cd 78 10 80       	push   $0x801078cd
...
80106c35:	e8 86 b8 ff ff       	call   801024c0 <kalloc>
...
80106c50:	e8 fb d7 ff ff       	call   80104450 <memset>
...
80106cef:	68 de 78 10 80       	push   $0x801078de
...
80106d40:	e8 bb d7 ff ff       	call   80104500 <memmove>
...
80106d95:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106d98:	e8 23 b7 ff ff       	call   801024c0 <kalloc>
