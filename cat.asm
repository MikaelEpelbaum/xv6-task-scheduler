...
00000402 <halt>:
SYSCALL(halt)
 402:	b8 32 00 00 00       	mov    $0x32,%eax
 407:	cd 40                	int    $0x40
 409:	c3                   	ret    
 ...
 419:	85 d2                	test   %edx,%edx
{
 ...
 447:	f7 f1                	div    %ecx
 449:	0f b6 92 58 09 00 00 	movzbl 0x958(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 50 09 00 00       	mov    $0x950,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 20 0d 00 00       	mov    0xd20,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 20 0d 00 00       	mov    %eax,0xd20
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 20 0d 00 00       	mov    %eax,0xd20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 20 0d 00 00    	mov    0xd20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 20 0d 00 00    	cmp    %eax,0xd20
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 20 0d 00 00    	mov    0xd20,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 20 0d 00 00    	mov    %edx,0xd20
}
 ...
 7c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 20 0d 00 00 24 	movl   $0xd24,0xd20
 7d7:	0d 00 00 
 7da:	c7 05 24 0d 00 00 24 	movl   $0xd24,0xd24
 7e1:	0d 00 00 
    base.s.size = 0;
 7e4:	b8 24 0d 00 00       	mov    $0xd24,%eax
 7e9:	c7 05 28 0d 00 00 00 	movl   $0x0,0xd28
 7f0:	00 00 00 
...
void check_proc_order(){
 ...
 815:	31 db                	xor    %ebx,%ebx
void check_proc_order(){
 817:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 81a:	e8 c3 fb ff ff       	call   3e2 <getpid>
 81f:	83 ec 04             	sub    $0x4,%esp
 822:	50                   	push   %eax
 823:	68 69 09 00 00       	push   $0x969
 828:	6a 01                	push   $0x1
 82a:	e8 81 fc ff ff       	call   4b0 <printf>
 82f:	83 c4 10             	add    $0x10,%esp
 832:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 838:	e8 1d fb ff ff       	call   35a <fork>
        if (pid < 0) {
 83d:	85 c0                	test   %eax,%eax
        int pid = fork();
 83f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 841:	78 4d                	js     890 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 843:	74 64                	je     8a9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 845:	83 c3 01             	add    $0x1,%ebx
 848:	83 fb 07             	cmp    $0x7,%ebx
 84b:	75 eb                	jne    838 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 84d:	e8 18 fb ff ff       	call   36a <wait>
 852:	e8 13 fb ff ff       	call   36a <wait>
 857:	e8 0e fb ff ff       	call   36a <wait>
 85c:	e8 09 fb ff ff       	call   36a <wait>
 861:	e8 04 fb ff ff       	call   36a <wait>
 866:	e8 ff fa ff ff       	call   36a <wait>
 86b:	e8 fa fa ff ff       	call   36a <wait>
    }
    printf(1,"\nPARENT finished\n");
 870:	83 ec 08             	sub    $0x8,%esp
 873:	68 9c 09 00 00       	push   $0x99c
 878:	6a 01                	push   $0x1
 87a:	e8 31 fc ff ff       	call   4b0 <printf>
 87f:	83 c4 10             	add    $0x10,%esp
}
 882:	8d 65 f8             	lea    -0x8(%ebp),%esp
 885:	5b                   	pop    %ebx
 886:	5e                   	pop    %esi
 887:	5d                   	pop    %ebp
 888:	c3                   	ret    
 ...
 893:	68 7f 09 00 00       	push   $0x97f
 898:	6a 01                	push   $0x1
 89a:	e8 11 fc ff ff       	call   4b0 <printf>
            return;
 89f:	83 c4 10             	add    $0x10,%esp
}
 8a2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 8a5:	5b                   	pop    %ebx
 8a6:	5e                   	pop    %esi
 8a7:	5d                   	pop    %ebp
 8a8:	c3                   	ret    
            int prio = prio_keys[k]; // index k inherited from parent
 8a9:	8b 1c 9d d0 09 00 00 	mov    0x9d0(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 8b0:	e8 2d fb ff ff       	call   3e2 <getpid>
 8b5:	53                   	push   %ebx
 8b6:	50                   	push   %eax
 8b7:	68 b0 09 00 00       	push   $0x9b0
 8bc:	6a 01                	push   $0x1
 8be:	e8 ed fb ff ff       	call   4b0 <printf>
            set_priority(prio);
 8c3:	89 1c 24             	mov    %ebx,(%esp)
 8c6:	e8 45 00 00 00       	call   910 <set_priority>
 8cb:	dd 05 30 0d 00 00    	fldl   0xd30
 8d1:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 8d4:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 8d7:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 8da:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 8dd:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 8e3:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 8e5:	75 ed                	jne    8d4 <check_proc_order+0xc4>
 8e7:	dd 1d 30 0d 00 00    	fstpl  0xd30
            printf(1,"\nChild(%d) DONE\n", getpid());
 8ed:	e8 f0 fa ff ff       	call   3e2 <getpid>
 8f2:	83 ec 04             	sub    $0x4,%esp
 8f5:	50                   	push   %eax
 8f6:	68 8b 09 00 00       	push   $0x98b
 8fb:	6a 01                	push   $0x1
 8fd:	e8 ae fb ff ff       	call   4b0 <printf>
            exit();
 902:	e8 5b fa ff ff       	call   362 <exit>
