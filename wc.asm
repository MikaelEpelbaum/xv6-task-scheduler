  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  f4:	74 42                	je     138 <wc+0x98>
      if(buf[i] == '\n')
  f6:	0f be 87 a0 0d 00 00 	movsbl 0xda0(%edi),%eax
        l++;
...
00000472 <halt>:
SYSCALL(halt)
 472:	b8 32 00 00 00       	mov    $0x32,%eax
 477:	cd 40                	int    $0x40
 479:	c3                   	ret    
 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 c8 09 00 00 	movzbl 0x9c8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb bf 09 00 00       	mov    $0x9bf,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 80 0d 00 00       	mov    0xd80,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 80 0d 00 00       	mov    %eax,0xd80
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 76a:	a3 80 0d 00 00       	mov    %eax,0xd80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 80 0d 00 00    	mov    0xd80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 80 0d 00 00    	cmp    %eax,0xd80
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 80 0d 00 00    	mov    0xd80,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 80 0d 00 00    	mov    %edx,0xd80
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 80 0d 00 00 84 	movl   $0xd84,0xd80
 847:	0d 00 00 
 84a:	c7 05 84 0d 00 00 84 	movl   $0xd84,0xd84
 851:	0d 00 00 
    base.s.size = 0;
 854:	b8 84 0d 00 00       	mov    $0xd84,%eax
 859:	c7 05 88 0d 00 00 00 	movl   $0x0,0xd88
 860:	00 00 00 
...
void check_proc_order(){
 887:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 88a:	e8 c3 fb ff ff       	call   452 <getpid>
 88f:	83 ec 04             	sub    $0x4,%esp
 892:	50                   	push   %eax
 893:	68 d9 09 00 00       	push   $0x9d9
 898:	6a 01                	push   $0x1
 89a:	e8 81 fc ff ff       	call   520 <printf>
 89f:	83 c4 10             	add    $0x10,%esp
 8a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 8a8:	e8 1d fb ff ff       	call   3ca <fork>
        if (pid < 0) {
 8ad:	85 c0                	test   %eax,%eax
        int pid = fork();
 8af:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 8b1:	78 4d                	js     900 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 8b3:	74 64                	je     919 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 8b5:	83 c3 01             	add    $0x1,%ebx
 8b8:	83 fb 07             	cmp    $0x7,%ebx
 8bb:	75 eb                	jne    8a8 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 8bd:	e8 18 fb ff ff       	call   3da <wait>
 8c2:	e8 13 fb ff ff       	call   3da <wait>
 8c7:	e8 0e fb ff ff       	call   3da <wait>
 8cc:	e8 09 fb ff ff       	call   3da <wait>
 8d1:	e8 04 fb ff ff       	call   3da <wait>
 8d6:	e8 ff fa ff ff       	call   3da <wait>
 8db:	e8 fa fa ff ff       	call   3da <wait>
    }
    printf(1,"\nPARENT finished\n");
 8e0:	83 ec 08             	sub    $0x8,%esp
 8e3:	68 0c 0a 00 00       	push   $0xa0c
 8e8:	6a 01                	push   $0x1
 8ea:	e8 31 fc ff ff       	call   520 <printf>
 ...
 903:	68 ef 09 00 00       	push   $0x9ef
 908:	6a 01                	push   $0x1
 90a:	e8 11 fc ff ff       	call   520 <printf>
            return;
 ...
 919:	8b 1c 9d 40 0a 00 00 	mov    0xa40(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 920:	e8 2d fb ff ff       	call   452 <getpid>
 925:	53                   	push   %ebx
 926:	50                   	push   %eax
 927:	68 20 0a 00 00       	push   $0xa20
 92c:	6a 01                	push   $0x1
 92e:	e8 ed fb ff ff       	call   520 <printf>
            set_priority(prio);
 933:	89 1c 24             	mov    %ebx,(%esp)
 936:	e8 45 00 00 00       	call   980 <set_priority>
 93b:	dd 05 90 0d 00 00    	fldl   0xd90
 941:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 944:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 947:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 94a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 94d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 953:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 955:	75 ed                	jne    944 <check_proc_order+0xc4>
 957:	dd 1d 90 0d 00 00    	fstpl  0xd90
            printf(1,"\nChild(%d) DONE\n", getpid());
 95d:	e8 f0 fa ff ff       	call   452 <getpid>
 962:	83 ec 04             	sub    $0x4,%esp
 965:	50                   	push   %eax
 966:	68 fb 09 00 00       	push   $0x9fb
 96b:	6a 01                	push   $0x1
 96d:	e8 ae fb ff ff       	call   520 <printf>
            exit();
 972:	e8 5b fa ff ff       	call   3d2 <exit>
