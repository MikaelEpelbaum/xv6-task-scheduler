...
000003e2 <halt>:
SYSCALL(halt)
 3e2:	b8 32 00 00 00       	mov    $0x32,%eax
 3e7:	cd 40                	int    $0x40
 3e9:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 48 09 00 00       	mov    $0x948,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 d8 0c 00 00       	mov    0xcd8,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 d8 0c 00 00       	mov    %eax,0xcd8
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 d8 0c 00 00       	mov    %eax,0xcd8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 d8 0c 00 00    	mov    0xcd8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 d8 0c 00 00    	cmp    %eax,0xcd8
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 d8 0c 00 00    	mov    0xcd8,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 d8 0c 00 00    	mov    %edx,0xcd8
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 d8 0c 00 00 dc 	movl   $0xcdc,0xcd8
 7b7:	0c 00 00 
 7ba:	c7 05 dc 0c 00 00 dc 	movl   $0xcdc,0xcdc
 7c1:	0c 00 00 
    base.s.size = 0;
 7c4:	b8 dc 0c 00 00       	mov    $0xcdc,%eax
 7c9:	c7 05 e0 0c 00 00 00 	movl   $0x0,0xce0
 7d0:	00 00 00 
...
void check_proc_order(){
 ...
 7f5:	31 db                	xor    %ebx,%ebx
void check_proc_order(){
 7f7:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 7fa:	e8 c3 fb ff ff       	call   3c2 <getpid>
 7ff:	83 ec 04             	sub    $0x4,%esp
 802:	50                   	push   %eax
 803:	68 61 09 00 00       	push   $0x961
 808:	6a 01                	push   $0x1
 80a:	e8 81 fc ff ff       	call   490 <printf>
 80f:	83 c4 10             	add    $0x10,%esp
 812:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 818:	e8 1d fb ff ff       	call   33a <fork>
        if (pid < 0) {
 81d:	85 c0                	test   %eax,%eax
        int pid = fork();
 81f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 821:	78 4d                	js     870 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 823:	74 64                	je     889 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 825:	83 c3 01             	add    $0x1,%ebx
 828:	83 fb 07             	cmp    $0x7,%ebx
 82b:	75 eb                	jne    818 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 82d:	e8 18 fb ff ff       	call   34a <wait>
 832:	e8 13 fb ff ff       	call   34a <wait>
 837:	e8 0e fb ff ff       	call   34a <wait>
 83c:	e8 09 fb ff ff       	call   34a <wait>
 841:	e8 04 fb ff ff       	call   34a <wait>
 846:	e8 ff fa ff ff       	call   34a <wait>
 84b:	e8 fa fa ff ff       	call   34a <wait>
    }
    printf(1,"\nPARENT finished\n");
 850:	83 ec 08             	sub    $0x8,%esp
 853:	68 94 09 00 00       	push   $0x994
 858:	6a 01                	push   $0x1
 85a:	e8 31 fc ff ff       	call   490 <printf>
 85f:	83 c4 10             	add    $0x10,%esp
}
 862:	8d 65 f8             	lea    -0x8(%ebp),%esp
 865:	5b                   	pop    %ebx
 866:	5e                   	pop    %esi
 867:	5d                   	pop    %ebp
 868:	c3                   	ret    
 ...
 873:	68 77 09 00 00       	push   $0x977
 878:	6a 01                	push   $0x1
 87a:	e8 11 fc ff ff       	call   490 <printf>
            return;
 ...
 889:	8b 1c 9d c8 09 00 00 	mov    0x9c8(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 890:	e8 2d fb ff ff       	call   3c2 <getpid>
 895:	53                   	push   %ebx
 896:	50                   	push   %eax
 897:	68 a8 09 00 00       	push   $0x9a8
 89c:	6a 01                	push   $0x1
 89e:	e8 ed fb ff ff       	call   490 <printf>
            set_priority(prio);
 8a3:	89 1c 24             	mov    %ebx,(%esp)
 8a6:	e8 45 00 00 00       	call   8f0 <set_priority>
 8ab:	dd 05 e8 0c 00 00    	fldl   0xce8
 8b1:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 8b4:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 8b7:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 8ba:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 8bd:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 8c3:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 8c5:	75 ed                	jne    8b4 <check_proc_order+0xc4>
 8c7:	dd 1d e8 0c 00 00    	fstpl  0xce8
            printf(1,"\nChild(%d) DONE\n", getpid());
 8cd:	e8 f0 fa ff ff       	call   3c2 <getpid>
 8d2:	83 ec 04             	sub    $0x4,%esp
 8d5:	50                   	push   %eax
 8d6:	68 83 09 00 00       	push   $0x983
 8db:	6a 01                	push   $0x1
 8dd:	e8 ae fb ff ff       	call   490 <printf>
            exit();
 8e2:	e8 5b fa ff ff       	call   342 <exit>
