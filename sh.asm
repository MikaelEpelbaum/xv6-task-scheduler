...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      38:	80 3d 62 1a 00 00 20 	cmpb   $0x20,0x1a62
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      57:	6a 64                	push   $0x64
      59:	68 60 1a 00 00       	push   $0x1a60
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      6a:	80 3d 60 1a 00 00 63 	cmpb   $0x63,0x1a60
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 61 1a 00 00 64 	cmpb   $0x64,0x1a61
  ...
  exit();
      ...
      e6:	50                   	push   %eax
      e7:	68 63 1a 00 00       	push   $0x1a63
      ec:	68 74 13 00 00       	push   $0x1374
      f1:	6a 02                	push   $0x2
...
00000100 <getcmd>:
{
  ...
  printf(2, "xv6$ ");
     ...
     10e:	68 c8 12 00 00       	push   $0x12c8
     113:	6a 02                	push   $0x2
...
00000150 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     159:	68 68 13 00 00       	push   $0x1368
     15e:	6a 02                	push   $0x2
...
00000170 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     189:	ff 24 85 84 13 00 00 	jmp    *0x1384(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1a9:	68 d5 12 00 00       	push   $0x12d5
     1ae:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     1fd:	68 e5 12 00 00       	push   $0x12e5
     202:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     290:	68 ce 12 00 00       	push   $0x12ce
     295:	e8 b6 fe ff ff       	call   150 <panic>
    panic("fork");
     29a:	83 ec 0c             	sub    $0xc,%esp
     29d:	68 f5 12 00 00       	push   $0x12f5
     ...
     2d8:	68 fa 12 00 00       	push   $0x12fa
...
00000310 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     325:	68 f5 12 00 00       	push   $0x12f5
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 58 1a 00 00       	push   $0x1a58
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 58 1a 00 00       	push   $0x1a58
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 50 1a 00 00       	push   $0x1a50
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 58 1a 00 00       	push   $0x1a58
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 58 1a 00 00       	push   $0x1a58
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     653:	68 1c 13 00 00       	push   $0x131c
     658:	53                   	push   %ebx
     659:	56                   	push   %esi
  ...
  return cmd;
     ...
     6de:	68 ff 12 00 00       	push   $0x12ff
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6ff:	68 1f 13 00 00       	push   $0x131f
     704:	57                   	push   %edi
     705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     74e:	68 36 13 00 00       	push   $0x1336
     753:	57                   	push   %edi
     754:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     798:	68 28 13 00 00       	push   $0x1328
  ...
  cmd->eargv[argc] = 0;
     ...
     7ea:	68 21 13 00 00       	push   $0x1321
...
00000800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     81b:	68 3b 13 00 00       	push   $0x133b
     820:	56                   	push   %esi
     821:	53                   	push   %ebx
...
00000870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8ab:	68 3d 13 00 00       	push   $0x133d
     8b0:	56                   	push   %esi
     8b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8c1:	68 39 13 00 00       	push   $0x1339
     8c6:	56                   	push   %esi
     8c7:	53                   	push   %ebx
...
00000910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     91f:	68 1f 13 00 00       	push   $0x131f
     924:	56                   	push   %esi
     925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     94b:	68 5b 13 00 00       	push   $0x135b
     950:	56                   	push   %esi
     951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9b5:	ff 24 85 9c 13 00 00 	jmp    *0x139c(,%eax,4)
...
00000a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a77:	68 ff 13 00 00       	push   $0x13ff
     a7c:	53                   	push   %ebx
     a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     a9f:	52                   	push   %edx
     aa0:	50                   	push   %eax
     aa1:	68 5d 13 00 00       	push   $0x135d
     aa6:	6a 02                	push   $0x2
     aa8:	e8 b3 03 00 00       	call   e60 <printf>
    panic("syntax");
     aad:	c7 04 24 21 13 00 00 	movl   $0x1321,(%esp)
...
00000db2 <halt>:
SYSCALL(halt)
     db2:	b8 32 00 00 00       	mov    $0x32,%eax
     db7:	cd 40                	int    $0x40
     db9:	c3                   	ret    
     ...
     dc9:	85 d2                	test   %edx,%edx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     df7:	f7 f1                	div    %ecx
     df9:	0f b6 92 bc 13 00 00 	movzbl 0x13bc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1014:	e9 8f fe ff ff       	jmp    ea8 <printf+0x48>
          s = "(null)";
    1019:	bb b4 13 00 00       	mov    $0x13b4,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1031:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
{
  ...
  freep = p;
    106f:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
}
    1074:	5b                   	pop    %ebx
    1075:	5e                   	pop    %esi
    1076:	5f                   	pop    %edi
    ...
    1086:	72 ce                	jb     1056 <free+0x26>
{
  ...
  freep = p;
    10aa:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10cc:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1111:	39 05 c4 1a 00 00    	cmp    %eax,0x1ac4
  ...
  return freep;
    113b:	8b 15 c4 1a 00 00    	mov    0x1ac4,%edx
    ...
    1164:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1167:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
    ...
    base.s.ptr = freep = prevp = &base;
    1180:	c7 05 c4 1a 00 00 c8 	movl   $0x1ac8,0x1ac4
    1187:	1a 00 00 
    118a:	c7 05 c8 1a 00 00 c8 	movl   $0x1ac8,0x1ac8
    1191:	1a 00 00 
    base.s.size = 0;
    1194:	b8 c8 1a 00 00       	mov    $0x1ac8,%eax
    1199:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
    11a0:	00 00 00 
...
void check_proc_order(){
    11c7:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
    11ca:	e8 c3 fb ff ff       	call   d92 <getpid>
    11cf:	83 ec 04             	sub    $0x4,%esp
    11d2:	50                   	push   %eax
    11d3:	68 cd 13 00 00       	push   $0x13cd
    11d8:	6a 01                	push   $0x1
    11da:	e8 81 fc ff ff       	call   e60 <printf>
    11df:	83 c4 10             	add    $0x10,%esp
    11e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
    11e8:	e8 1d fb ff ff       	call   d0a <fork>
        if (pid < 0) {
    11ed:	85 c0                	test   %eax,%eax
        int pid = fork();
    11ef:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
    11f1:	78 4d                	js     1240 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
    11f3:	74 64                	je     1259 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
    11f5:	83 c3 01             	add    $0x1,%ebx
    11f8:	83 fb 07             	cmp    $0x7,%ebx
    11fb:	75 eb                	jne    11e8 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
    11fd:	e8 18 fb ff ff       	call   d1a <wait>
    1202:	e8 13 fb ff ff       	call   d1a <wait>
    1207:	e8 0e fb ff ff       	call   d1a <wait>
    120c:	e8 09 fb ff ff       	call   d1a <wait>
    1211:	e8 04 fb ff ff       	call   d1a <wait>
    1216:	e8 ff fa ff ff       	call   d1a <wait>
    121b:	e8 fa fa ff ff       	call   d1a <wait>
    }
    printf(1,"\nPARENT finished\n");
    1220:	83 ec 08             	sub    $0x8,%esp
    1223:	68 00 14 00 00       	push   $0x1400
    1228:	6a 01                	push   $0x1
    122a:	e8 31 fc ff ff       	call   e60 <printf>
    ...
    1243:	68 e3 13 00 00       	push   $0x13e3
    1248:	6a 01                	push   $0x1
    124a:	e8 11 fc ff ff       	call   e60 <printf>
            return;
    124f:	83 c4 10             	add    $0x10,%esp
}
    1252:	8d 65 f8             	lea    -0x8(%ebp),%esp
    1255:	5b                   	pop    %ebx
    1256:	5e                   	pop    %esi
    1257:	5d                   	pop    %ebp
    1258:	c3                   	ret    
            int prio = prio_keys[k]; // index k inherited from parent
    1259:	8b 1c 9d 34 14 00 00 	mov    0x1434(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
    1260:	e8 2d fb ff ff       	call   d92 <getpid>
    1265:	53                   	push   %ebx
    1266:	50                   	push   %eax
    1267:	68 14 14 00 00       	push   $0x1414
    126c:	6a 01                	push   $0x1
    126e:	e8 ed fb ff ff       	call   e60 <printf>
            set_priority(prio);
    1273:	89 1c 24             	mov    %ebx,(%esp)
    1276:	e8 45 00 00 00       	call   12c0 <set_priority>
    127b:	dd 05 d0 1a 00 00    	fldl   0x1ad0
    1281:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
    1284:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
    1287:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
    128a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
    128d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
    1293:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
    1295:	75 ed                	jne    1284 <check_proc_order+0xc4>
    1297:	dd 1d d0 1a 00 00    	fstpl  0x1ad0
            printf(1,"\nChild(%d) DONE\n", getpid());
    129d:	e8 f0 fa ff ff       	call   d92 <getpid>
    12a2:	83 ec 04             	sub    $0x4,%esp
    12a5:	50                   	push   %eax
    12a6:	68 ef 13 00 00       	push   $0x13ef
    12ab:	6a 01                	push   $0x1
    12ad:	e8 ae fb ff ff       	call   e60 <printf>
            exit();
    12b2:	e8 5b fa ff ff       	call   d12 <exit>
