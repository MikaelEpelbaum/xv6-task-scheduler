...
main(int argc, char *argv[])
{
  ...
  28:	68 78 08 00 00       	push   $0x878
  2d:	50                   	push   %eax
  2e:	68 7a 08 00 00       	push   $0x87a
  33:	6a 01                	push   $0x1
  ...
  47:	68 ca 08 00 00       	push   $0x8ca
  4c:	50                   	push   %eax
  4d:	68 7a 08 00 00       	push   $0x87a
  52:	6a 01                	push   $0x1
...
00000362 <halt>:
SYSCALL(halt)
 362:	b8 32 00 00 00       	mov    $0x32,%eax
 367:	cd 40                	int    $0x40
 369:	c3                   	ret    
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 7f 08 00 00       	mov    $0x87f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e1:	a1 10 0c 00 00       	mov    0xc10,%eax
{
 ...
 61d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 61f:	a3 10 0c 00 00       	mov    %eax,0xc10
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 10 0c 00 00       	mov    %eax,0xc10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 10 0c 00 00    	mov    0xc10,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
    ...
    if(p == freep)
 6c1:	39 05 10 0c 00 00    	cmp    %eax,0xc10
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
  return freep;
 6eb:	8b 15 10 0c 00 00    	mov    0xc10,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 717:	89 15 10 0c 00 00    	mov    %edx,0xc10
}
 ...
 729:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 10 0c 00 00 14 	movl   $0xc14,0xc10
 737:	0c 00 00 
 73a:	c7 05 14 0c 00 00 14 	movl   $0xc14,0xc14
 741:	0c 00 00 
    base.s.size = 0;
 744:	b8 14 0c 00 00       	mov    $0xc14,%eax
 749:	c7 05 18 0c 00 00 00 	movl   $0x0,0xc18
 750:	00 00 00 
...
void check_proc_order(){
 777:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 77a:	e8 c3 fb ff ff       	call   342 <getpid>
 77f:	83 ec 04             	sub    $0x4,%esp
 782:	50                   	push   %eax
 783:	68 99 08 00 00       	push   $0x899
 788:	6a 01                	push   $0x1
 78a:	e8 81 fc ff ff       	call   410 <printf>
 78f:	83 c4 10             	add    $0x10,%esp
 792:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 798:	e8 1d fb ff ff       	call   2ba <fork>
        if (pid < 0) {
 79d:	85 c0                	test   %eax,%eax
        int pid = fork();
 79f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 7a1:	78 4d                	js     7f0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 7a3:	74 64                	je     809 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 7a5:	83 c3 01             	add    $0x1,%ebx
 7a8:	83 fb 07             	cmp    $0x7,%ebx
 7ab:	75 eb                	jne    798 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 7ad:	e8 18 fb ff ff       	call   2ca <wait>
 7b2:	e8 13 fb ff ff       	call   2ca <wait>
 7b7:	e8 0e fb ff ff       	call   2ca <wait>
 7bc:	e8 09 fb ff ff       	call   2ca <wait>
 7c1:	e8 04 fb ff ff       	call   2ca <wait>
 7c6:	e8 ff fa ff ff       	call   2ca <wait>
 7cb:	e8 fa fa ff ff       	call   2ca <wait>
    }
    printf(1,"\nPARENT finished\n");
 7d0:	83 ec 08             	sub    $0x8,%esp
 7d3:	68 cc 08 00 00       	push   $0x8cc
 7d8:	6a 01                	push   $0x1
 7da:	e8 31 fc ff ff       	call   410 <printf>
 ...
 7f3:	68 af 08 00 00       	push   $0x8af
 7f8:	6a 01                	push   $0x1
 7fa:	e8 11 fc ff ff       	call   410 <printf>
            return;
 ...
 809:	8b 1c 9d 00 09 00 00 	mov    0x900(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 810:	e8 2d fb ff ff       	call   342 <getpid>
 815:	53                   	push   %ebx
 816:	50                   	push   %eax
 817:	68 e0 08 00 00       	push   $0x8e0
 81c:	6a 01                	push   $0x1
 81e:	e8 ed fb ff ff       	call   410 <printf>
            set_priority(prio);
 823:	89 1c 24             	mov    %ebx,(%esp)
 826:	e8 45 00 00 00       	call   870 <set_priority>
 82b:	dd 05 20 0c 00 00    	fldl   0xc20
 831:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 834:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 837:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 83a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 83d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 843:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 845:	75 ed                	jne    834 <check_proc_order+0xc4>
 847:	dd 1d 20 0c 00 00    	fstpl  0xc20
            printf(1,"\nChild(%d) DONE\n", getpid());
 84d:	e8 f0 fa ff ff       	call   342 <getpid>
 852:	83 ec 04             	sub    $0x4,%esp
 855:	50                   	push   %eax
 856:	68 bb 08 00 00       	push   $0x8bb
 85b:	6a 01                	push   $0x1
 85d:	e8 ae fb ff ff       	call   410 <printf>
            exit();
 862:	e8 5b fa ff ff       	call   2c2 <exit>
