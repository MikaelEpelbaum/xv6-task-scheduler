...
00000322 <halt>:
SYSCALL(halt)
 322:	b8 32 00 00 00       	mov    $0x32,%eax
 327:	cd 40                	int    $0x40
 329:	c3                   	ret    
 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 584:	e9 8f fe ff ff       	jmp    418 <printf+0x48>
          s = "(null)";
 589:	bb 38 08 00 00       	mov    $0x838,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5a1:	a1 c0 0b 00 00       	mov    0xbc0,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 c0 0b 00 00       	mov    %eax,0xbc0
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 c0 0b 00 00       	mov    %eax,0xbc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 c0 0b 00 00    	mov    0xbc0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 47                	jae    6c8 <malloc+0x98>
    ...
    if(p == freep)
 681:	39 05 c0 0b 00 00    	cmp    %eax,0xbc0
 ...
 6a6:	e8 f5 fe ff ff       	call   5a0 <free>
  return freep;
 6ab:	8b 15 c0 0b 00 00    	mov    0xbc0,%edx
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 c0 0b 00 00    	mov    %edx,0xbc0
}
 ...
 6e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 c0 0b 00 00 c4 	movl   $0xbc4,0xbc0
 6f7:	0b 00 00 
 6fa:	c7 05 c4 0b 00 00 c4 	movl   $0xbc4,0xbc4
 701:	0b 00 00 
    base.s.size = 0;
 704:	b8 c4 0b 00 00       	mov    $0xbc4,%eax
 709:	c7 05 c8 0b 00 00 00 	movl   $0x0,0xbc8
 710:	00 00 00 
...
void check_proc_order(){
 737:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 73a:	e8 c3 fb ff ff       	call   302 <getpid>
 73f:	83 ec 04             	sub    $0x4,%esp
 742:	50                   	push   %eax
 743:	68 51 08 00 00       	push   $0x851
 748:	6a 01                	push   $0x1
 74a:	e8 81 fc ff ff       	call   3d0 <printf>
 74f:	83 c4 10             	add    $0x10,%esp
 752:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 758:	e8 1d fb ff ff       	call   27a <fork>
        if (pid < 0) {
 75d:	85 c0                	test   %eax,%eax
        int pid = fork();
 75f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 761:	78 4d                	js     7b0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 763:	74 64                	je     7c9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 765:	83 c3 01             	add    $0x1,%ebx
 768:	83 fb 07             	cmp    $0x7,%ebx
 76b:	75 eb                	jne    758 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 76d:	e8 18 fb ff ff       	call   28a <wait>
 772:	e8 13 fb ff ff       	call   28a <wait>
 777:	e8 0e fb ff ff       	call   28a <wait>
 77c:	e8 09 fb ff ff       	call   28a <wait>
 781:	e8 04 fb ff ff       	call   28a <wait>
 786:	e8 ff fa ff ff       	call   28a <wait>
 78b:	e8 fa fa ff ff       	call   28a <wait>
    }
    printf(1,"\nPARENT finished\n");
 790:	83 ec 08             	sub    $0x8,%esp
 793:	68 84 08 00 00       	push   $0x884
 798:	6a 01                	push   $0x1
 79a:	e8 31 fc ff ff       	call   3d0 <printf>
 79f:	83 c4 10             	add    $0x10,%esp
}
 7a2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 7a5:	5b                   	pop    %ebx
 7a6:	5e                   	pop    %esi
 7a7:	5d                   	pop    %ebp
 7a8:	c3                   	ret    
 ...
 7b3:	68 67 08 00 00       	push   $0x867
 7b8:	6a 01                	push   $0x1
 7ba:	e8 11 fc ff ff       	call   3d0 <printf>
            return;
 ...
 7c9:	8b 1c 9d b8 08 00 00 	mov    0x8b8(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 7d0:	e8 2d fb ff ff       	call   302 <getpid>
 7d5:	53                   	push   %ebx
 7d6:	50                   	push   %eax
 7d7:	68 98 08 00 00       	push   $0x898
 7dc:	6a 01                	push   $0x1
 7de:	e8 ed fb ff ff       	call   3d0 <printf>
            set_priority(prio);
 7e3:	89 1c 24             	mov    %ebx,(%esp)
 7e6:	e8 45 00 00 00       	call   830 <set_priority>
 7eb:	dd 05 d0 0b 00 00    	fldl   0xbd0
 7f1:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 7f4:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 7f7:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 7fa:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 7fd:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 803:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 805:	75 ed                	jne    7f4 <check_proc_order+0xc4>
 807:	dd 1d d0 0b 00 00    	fstpl  0xbd0
            printf(1,"\nChild(%d) DONE\n", getpid());
 80d:	e8 f0 fa ff ff       	call   302 <getpid>
 812:	83 ec 04             	sub    $0x4,%esp
 815:	50                   	push   %eax
 816:	68 73 08 00 00       	push   $0x873
 81b:	6a 01                	push   $0x1
 81d:	e8 ae fb ff ff       	call   3d0 <printf>
            exit();
 822:	e8 5b fa ff ff       	call   282 <exit>
