...
00000372 <halt>:
SYSCALL(halt)
 372:	b8 32 00 00 00       	mov    $0x32,%eax
 377:	cd 40                	int    $0x40
 379:	c3                   	ret    
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb b5 08 00 00       	mov    $0x8b5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 48 0c 00 00       	mov    0xc48,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 48 0c 00 00       	mov    %eax,0xc48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 48 0c 00 00    	mov    0xc48,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 48 0c 00 00    	cmp    %eax,0xc48
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 48 0c 00 00    	mov    0xc48,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 48 0c 00 00    	mov    %edx,0xc48
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 48 0c 00 00 4c 	movl   $0xc4c,0xc48
 747:	0c 00 00 
 74a:	c7 05 4c 0c 00 00 4c 	movl   $0xc4c,0xc4c
 751:	0c 00 00 
    base.s.size = 0;
 754:	b8 4c 0c 00 00       	mov    $0xc4c,%eax
 759:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 760:	00 00 00 
...
void check_proc_order(){
 ...
 785:	31 db                	xor    %ebx,%ebx
void check_proc_order(){
 787:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 78a:	e8 c3 fb ff ff       	call   352 <getpid>
 78f:	83 ec 04             	sub    $0x4,%esp
 792:	50                   	push   %eax
 793:	68 cd 08 00 00       	push   $0x8cd
 798:	6a 01                	push   $0x1
 79a:	e8 81 fc ff ff       	call   420 <printf>
 79f:	83 c4 10             	add    $0x10,%esp
 7a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 7a8:	e8 1d fb ff ff       	call   2ca <fork>
        if (pid < 0) {
 7ad:	85 c0                	test   %eax,%eax
        int pid = fork();
 7af:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 7b1:	78 4d                	js     800 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 7b3:	74 64                	je     819 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 7b5:	83 c3 01             	add    $0x1,%ebx
 7b8:	83 fb 07             	cmp    $0x7,%ebx
 7bb:	75 eb                	jne    7a8 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 7bd:	e8 18 fb ff ff       	call   2da <wait>
 7c2:	e8 13 fb ff ff       	call   2da <wait>
 7c7:	e8 0e fb ff ff       	call   2da <wait>
 7cc:	e8 09 fb ff ff       	call   2da <wait>
 7d1:	e8 04 fb ff ff       	call   2da <wait>
 7d6:	e8 ff fa ff ff       	call   2da <wait>
 7db:	e8 fa fa ff ff       	call   2da <wait>
    }
    printf(1,"\nPARENT finished\n");
 7e0:	83 ec 08             	sub    $0x8,%esp
 7e3:	68 00 09 00 00       	push   $0x900
 7e8:	6a 01                	push   $0x1
 7ea:	e8 31 fc ff ff       	call   420 <printf>
 7ef:	83 c4 10             	add    $0x10,%esp
}
 7f2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 7f5:	5b                   	pop    %ebx
 7f6:	5e                   	pop    %esi
 7f7:	5d                   	pop    %ebp
 7f8:	c3                   	ret    
 ...
 803:	68 e3 08 00 00       	push   $0x8e3
 808:	6a 01                	push   $0x1
 80a:	e8 11 fc ff ff       	call   420 <printf>
            return;
 80f:	83 c4 10             	add    $0x10,%esp
}
 812:	8d 65 f8             	lea    -0x8(%ebp),%esp
 815:	5b                   	pop    %ebx
 816:	5e                   	pop    %esi
 817:	5d                   	pop    %ebp
 818:	c3                   	ret    
            int prio = prio_keys[k]; // index k inherited from parent
 819:	8b 1c 9d 34 09 00 00 	mov    0x934(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 820:	e8 2d fb ff ff       	call   352 <getpid>
 825:	53                   	push   %ebx
 826:	50                   	push   %eax
 827:	68 14 09 00 00       	push   $0x914
 82c:	6a 01                	push   $0x1
 82e:	e8 ed fb ff ff       	call   420 <printf>
            set_priority(prio);
 833:	89 1c 24             	mov    %ebx,(%esp)
 836:	e8 45 00 00 00       	call   880 <set_priority>
 83b:	dd 05 58 0c 00 00    	fldl   0xc58
 841:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 844:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 847:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 84a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 84d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 853:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 855:	75 ed                	jne    844 <check_proc_order+0xc4>
 857:	dd 1d 58 0c 00 00    	fstpl  0xc58
            printf(1,"\nChild(%d) DONE\n", getpid());
 85d:	e8 f0 fa ff ff       	call   352 <getpid>
 862:	83 ec 04             	sub    $0x4,%esp
 865:	50                   	push   %eax
 866:	68 ef 08 00 00       	push   $0x8ef
 86b:	6a 01                	push   $0x1
 86d:	e8 ae fb ff ff       	call   420 <printf>
            exit();
 872:	e8 5b fa ff ff       	call   2d2 <exit>
