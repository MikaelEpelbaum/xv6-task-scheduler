...
_fairness:     file format elf32-i386
...
int main(int argc, char *argv[]){
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    check_proc_order();
  11:	e8 0a 07 00 00       	call   720 <check_proc_order>
    exit();
...
00000312 <halt>:
SYSCALL(halt)
 312:	b8 32 00 00 00       	mov    $0x32,%eax
 317:	cd 40                	int    $0x40
 319:	c3                   	ret    
 ...
 329:	85 d2                	test   %edx,%edx
{
 ...
 357:	f7 f1                	div    %ecx
 359:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 574:	e9 8f fe ff ff       	jmp    408 <printf+0x48>
          s = "(null)";
 579:	bb 28 08 00 00       	mov    $0x828,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 591:	a1 b0 0b 00 00       	mov    0xbb0,%eax
{
 ...
 5cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5cf:	a3 b0 0b 00 00       	mov    %eax,0xbb0
}
 5d4:	5b                   	pop    %ebx
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 ...
 5e6:	72 ce                	jb     5b6 <free+0x26>
{
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60a:	a3 b0 0b 00 00       	mov    %eax,0xbb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	73 47                	jae    6b8 <malloc+0x98>
    ...
    if(p == freep)
 671:	39 05 b0 0b 00 00    	cmp    %eax,0xbb0
 ...
 696:	e8 f5 fe ff ff       	call   590 <free>
  return freep;
 69b:	8b 15 b0 0b 00 00    	mov    0xbb0,%edx
 ...
 6c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6c7:	89 15 b0 0b 00 00    	mov    %edx,0xbb0
}
 ...
 6d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 b0 0b 00 00 b4 	movl   $0xbb4,0xbb0
 6e7:	0b 00 00 
 6ea:	c7 05 b4 0b 00 00 b4 	movl   $0xbb4,0xbb4
 6f1:	0b 00 00 
    base.s.size = 0;
 6f4:	b8 b4 0b 00 00       	mov    $0xbb4,%eax
 6f9:	c7 05 b8 0b 00 00 00 	movl   $0x0,0xbb8
 700:	00 00 00 
...
void check_proc_order(){
 727:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 72a:	e8 c3 fb ff ff       	call   2f2 <getpid>
 72f:	83 ec 04             	sub    $0x4,%esp
 732:	50                   	push   %eax
 733:	68 41 08 00 00       	push   $0x841
 738:	6a 01                	push   $0x1
 73a:	e8 81 fc ff ff       	call   3c0 <printf>
 73f:	83 c4 10             	add    $0x10,%esp
 742:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 748:	e8 1d fb ff ff       	call   26a <fork>
        if (pid < 0) {
 74d:	85 c0                	test   %eax,%eax
        int pid = fork();
 74f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 751:	78 4d                	js     7a0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 753:	74 64                	je     7b9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 755:	83 c3 01             	add    $0x1,%ebx
 758:	83 fb 07             	cmp    $0x7,%ebx
 75b:	75 eb                	jne    748 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 75d:	e8 18 fb ff ff       	call   27a <wait>
 762:	e8 13 fb ff ff       	call   27a <wait>
 767:	e8 0e fb ff ff       	call   27a <wait>
 76c:	e8 09 fb ff ff       	call   27a <wait>
 771:	e8 04 fb ff ff       	call   27a <wait>
 776:	e8 ff fa ff ff       	call   27a <wait>
 77b:	e8 fa fa ff ff       	call   27a <wait>
    }
    printf(1,"\nPARENT finished\n");
 780:	83 ec 08             	sub    $0x8,%esp
 783:	68 74 08 00 00       	push   $0x874
 788:	6a 01                	push   $0x1
 78a:	e8 31 fc ff ff       	call   3c0 <printf>
 ...
 7a3:	68 57 08 00 00       	push   $0x857
 7a8:	6a 01                	push   $0x1
 7aa:	e8 11 fc ff ff       	call   3c0 <printf>
            return;
 7af:	83 c4 10             	add    $0x10,%esp
}
 7b2:	8d 65 f8             	lea    -0x8(%ebp),%esp
 7b5:	5b                   	pop    %ebx
 7b6:	5e                   	pop    %esi
 7b7:	5d                   	pop    %ebp
 7b8:	c3                   	ret    
            int prio = prio_keys[k]; // index k inherited from parent
 7b9:	8b 1c 9d a8 08 00 00 	mov    0x8a8(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 7c0:	e8 2d fb ff ff       	call   2f2 <getpid>
 7c5:	53                   	push   %ebx
 7c6:	50                   	push   %eax
 7c7:	68 88 08 00 00       	push   $0x888
 7cc:	6a 01                	push   $0x1
 7ce:	e8 ed fb ff ff       	call   3c0 <printf>
            set_priority(prio);
 7d3:	89 1c 24             	mov    %ebx,(%esp)
 7d6:	e8 45 00 00 00       	call   820 <set_priority>
 7db:	dd 05 c0 0b 00 00    	fldl   0xbc0
 7e1:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 7e4:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 7e7:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 7ea:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 7ed:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 7f3:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 7f5:	75 ed                	jne    7e4 <check_proc_order+0xc4>
 7f7:	dd 1d c0 0b 00 00    	fstpl  0xbc0
            printf(1,"\nChild(%d) DONE\n", getpid());
 7fd:	e8 f0 fa ff ff       	call   2f2 <getpid>
 802:	83 ec 04             	sub    $0x4,%esp
 805:	50                   	push   %eax
 806:	68 63 08 00 00       	push   $0x863
 80b:	6a 01                	push   $0x1
 80d:	e8 ae fb ff ff       	call   3c0 <printf>
            exit();
 812:	e8 5b fa ff ff       	call   272 <exit>
