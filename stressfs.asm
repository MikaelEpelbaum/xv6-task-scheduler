...
00000432 <halt>:
SYSCALL(halt)
 432:	b8 32 00 00 00       	mov    $0x32,%eax
 437:	cd 40                	int    $0x40
 439:	c3                   	ret    
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 74 09 00 00 	movzbl 0x974(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 6b 09 00 00       	mov    $0x96b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 00 0d 00 00       	mov    0xd00,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 00 0d 00 00       	mov    %eax,0xd00
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 72a:	a3 00 0d 00 00       	mov    %eax,0xd00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 00 0d 00 00    	mov    0xd00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 00 0d 00 00    	cmp    %eax,0xd00
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 00 0d 00 00    	mov    0xd00,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 00 0d 00 00    	mov    %edx,0xd00
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 00 0d 00 00 04 	movl   $0xd04,0xd00
 807:	0d 00 00 
 80a:	c7 05 04 0d 00 00 04 	movl   $0xd04,0xd04
 811:	0d 00 00 
    base.s.size = 0;
 814:	b8 04 0d 00 00       	mov    $0xd04,%eax
 819:	c7 05 08 0d 00 00 00 	movl   $0x0,0xd08
 820:	00 00 00 
...
void check_proc_order(){
 847:	83 ec 10             	sub    $0x10,%esp
    printf(1, "parent run at pid %d\n", getpid());
 84a:	e8 c3 fb ff ff       	call   412 <getpid>
 84f:	83 ec 04             	sub    $0x4,%esp
 852:	50                   	push   %eax
 853:	68 85 09 00 00       	push   $0x985
 858:	6a 01                	push   $0x1
 85a:	e8 81 fc ff ff       	call   4e0 <printf>
 85f:	83 c4 10             	add    $0x10,%esp
 862:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        int pid = fork();
 868:	e8 1d fb ff ff       	call   38a <fork>
        if (pid < 0) {
 86d:	85 c0                	test   %eax,%eax
        int pid = fork();
 86f:	89 c6                	mov    %eax,%esi
        if (pid < 0) {
 871:	78 4d                	js     8c0 <check_proc_order+0x80>
            printf(1, "fork failed");
            return;
        }
        if (pid == 0) {
 873:	74 64                	je     8d9 <check_proc_order+0x99>
    for(int k = 0; k < num_children;k++) {
 875:	83 c3 01             	add    $0x1,%ebx
 878:	83 fb 07             	cmp    $0x7,%ebx
 87b:	75 eb                	jne    868 <check_proc_order+0x28>
    }
    ...
    for(int i = 0; i < num_children; i++) {
        wait();
 87d:	e8 18 fb ff ff       	call   39a <wait>
 882:	e8 13 fb ff ff       	call   39a <wait>
 887:	e8 0e fb ff ff       	call   39a <wait>
 88c:	e8 09 fb ff ff       	call   39a <wait>
 891:	e8 04 fb ff ff       	call   39a <wait>
 896:	e8 ff fa ff ff       	call   39a <wait>
 89b:	e8 fa fa ff ff       	call   39a <wait>
    }
    printf(1,"\nPARENT finished\n");
 8a0:	83 ec 08             	sub    $0x8,%esp
 8a3:	68 b8 09 00 00       	push   $0x9b8
 8a8:	6a 01                	push   $0x1
 8aa:	e8 31 fc ff ff       	call   4e0 <printf>
 ...
 8c3:	68 9b 09 00 00       	push   $0x99b
 8c8:	6a 01                	push   $0x1
 8ca:	e8 11 fc ff ff       	call   4e0 <printf>
            return;
 ...
 8d9:	8b 1c 9d ec 09 00 00 	mov    0x9ec(,%ebx,4),%ebx
		    printf(1,"Child(%d) is setting prio: %d\n", getpid(), prio);
 8e0:	e8 2d fb ff ff       	call   412 <getpid>
 8e5:	53                   	push   %ebx
 8e6:	50                   	push   %eax
 8e7:	68 cc 09 00 00       	push   $0x9cc
 8ec:	6a 01                	push   $0x1
 8ee:	e8 ed fb ff ff       	call   4e0 <printf>
            set_priority(prio);
 8f3:	89 1c 24             	mov    %ebx,(%esp)
 8f6:	e8 45 00 00 00       	call   940 <set_priority>
 8fb:	dd 05 10 0d 00 00    	fldl   0xd10
 901:	83 c4 10             	add    $0x10,%esp
                    x += k; // x is global so the compiler cannot remove this loop
 904:	89 75 f4             	mov    %esi,-0xc(%ebp)
            for(k=0;k< iterations;k++){
 907:	83 c6 01             	add    $0x1,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 90a:	db 45 f4             	fildl  -0xc(%ebp)
            for(k=0;k< iterations;k++){
 90d:	81 fe 80 f0 fa 02    	cmp    $0x2faf080,%esi
                    x += k; // x is global so the compiler cannot remove this loop
 913:	de c1                	faddp  %st,%st(1)
            for(k=0;k< iterations;k++){
 915:	75 ed                	jne    904 <check_proc_order+0xc4>
 917:	dd 1d 10 0d 00 00    	fstpl  0xd10
            printf(1,"\nChild(%d) DONE\n", getpid());
 91d:	e8 f0 fa ff ff       	call   412 <getpid>
 922:	83 ec 04             	sub    $0x4,%esp
 925:	50                   	push   %eax
 926:	68 a7 09 00 00       	push   $0x9a7
 92b:	6a 01                	push   $0x1
 92d:	e8 ae fb ff ff       	call   4e0 <printf>
            exit();
 932:	e8 5b fa ff ff       	call   392 <exit>
