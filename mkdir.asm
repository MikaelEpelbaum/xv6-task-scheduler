 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb bb 08 00 00       	mov    $0x8bb,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 50 0c 00 00       	mov    0xc50,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 50 0c 00 00       	mov    %eax,0xc50
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 50 0c 00 00       	mov    %eax,0xc50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 50 0c 00 00    	mov    0xc50,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 50 0c 00 00    	cmp    %eax,0xc50
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 50 0c 00 00    	mov    0xc50,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 50 0c 00 00    	mov    %edx,0xc50
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 50 0c 00 00 54 	movl   $0xc54,0xc50
 747:	0c 00 00 
 74a:	c7 05 54 0c 00 00 54 	movl   $0xc54,0xc54
 751:	0c 00 00 
    base.s.size = 0;
 754:	b8 54 0c 00 00       	mov    $0xc54,%eax
 759:	c7 05 58 0c 00 00 00 	movl   $0x0,0xc58
 760:	00 00 00 
...
void check_proc_order(){
 ...
 857:	dd 1d 60 0c 00 00    	fstpl  0xc60
            printf(1,"\nChild(%d) DONE\n", getpid());
 85d:	e8 f0 fa ff ff       	call   352 <getpid>
 862:	83 ec 04             	sub    $0x4,%esp
 865:	50                   	push   %eax
 866:	68 f7 08 00 00       	push   $0x8f7
 86b:	6a 01                	push   $0x1
