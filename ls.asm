 ...
 639:	85 d2                	test   %edx,%edx
{
 ...
 667:	f7 f1                	div    %ecx
 669:	0f b6 92 8c 0b 00 00 	movzbl 0xb8c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 884:	e9 8f fe ff ff       	jmp    718 <printf+0x48>
          s = "(null)";
 889:	bb 82 0b 00 00       	mov    $0xb82,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8a1:	a1 98 0f 00 00       	mov    0xf98,%eax
{
 ...
 8dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8df:	a3 98 0f 00 00       	mov    %eax,0xf98
}
 8e4:	5b                   	pop    %ebx
 8e5:	5e                   	pop    %esi
 8e6:	5f                   	pop    %edi
 ...
 8f6:	72 ce                	jb     8c6 <free+0x26>
{
 ...
 917:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 91a:	a3 98 0f 00 00       	mov    %eax,0xf98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 939:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 93c:	8b 15 98 0f 00 00    	mov    0xf98,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 97f:	73 47                	jae    9c8 <malloc+0x98>
    ...
    if(p == freep)
 981:	39 05 98 0f 00 00    	cmp    %eax,0xf98
 ...
 9a6:	e8 f5 fe ff ff       	call   8a0 <free>
  return freep;
 9ab:	8b 15 98 0f 00 00    	mov    0xf98,%edx
 ...
 9d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9d7:	89 15 98 0f 00 00    	mov    %edx,0xf98
}
 ...
 9e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 9f0:	c7 05 98 0f 00 00 9c 	movl   $0xf9c,0xf98
 9f7:	0f 00 00 
 9fa:	c7 05 9c 0f 00 00 9c 	movl   $0xf9c,0xf9c
 a01:	0f 00 00 
    base.s.size = 0;
 a04:	b8 9c 0f 00 00       	mov    $0xf9c,%eax
 a09:	c7 05 a0 0f 00 00 00 	movl   $0x0,0xfa0
 a10:	00 00 00 
...
void check_proc_order(){
 ...
 b07:	dd 1d a8 0f 00 00    	fstpl  0xfa8
            printf(1,"\nChild(%d) DONE\n", getpid());
 b0d:	e8 f0 fa ff ff       	call   602 <getpid>
 b12:	83 ec 04             	sub    $0x4,%esp
 b15:	50                   	push   %eax
 b16:	68 bf 0b 00 00       	push   $0xbbf
 b1b:	6a 01                	push   $0x1
